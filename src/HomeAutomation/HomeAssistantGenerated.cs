...
//   At: 2026-08-07T08:55:49.0479064+08:00
//
...
public static class GeneratedExtensions
{
    ...
    public static IServiceCollection AddHomeAssistantGenerated(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddTransient<TapoControlServices>();
        ...
        serviceCollection.AddTransient<TuyaServices>();
...
public partial class LightEntities
{
    ...
    ///<summary>Baby Camera Floodlight (Timed)</summary>
    public LightEntity BabyCameraFloodlightTimed => new(_haContext, "light.baby_camera_floodlight_timed");
    ...
    ///<summary>Bathroom Motion Sensor Status LED</summary>
    public LightEntity BathroomMotionSensorStatusLed => new(_haContext, "light.bathroom_motion_sensor_status_led");
    ...
    ///<summary>browser_mod_d407d4ae_c3026b27 Screen</summary>
    public LightEntity BrowserModD407d4aeC3026b27Screen => new(_haContext, "light.browser_mod_d407d4ae_c3026b27_screen");
    ...
    public LightEntity GuestScreen => new(_haContext, "light.guest_screen");
    ...
    ///<summary>OnePlus13 Screen</summary>
    public LightEntity Oneplus13Screen => new(_haContext, "light.oneplus13_screen");
    ...
    public LightEntity SalaLights => new(_haContext, "light.sala_lights");
    ///<summary>Sala Lights 2</summary>
    public LightEntity SalaLights2 => new(_haContext, "light.sala_lights_2");
    ///<summary>Sala Lights</summary>
    public LightEntity SalaLightsGroup => new(_haContext, "light.sala_lights_group");
    ///<summary>Sala Lights + Kitchen</summary>
    public LightEntity SalaLightsKitchen => new(_haContext, "light.sala_lights_kitchen");
    ...
    ///<summary>Desk Motion Sensor Status LED</summary>
    public LightEntity ZEsp32C61StatusLed2 => new(_haContext, "light.z_esp32_c6_1_status_led_2");
    ///<summary>Pantry Motion Sensor Status LED</summary>
    public LightEntity ZEsp32C63StatusLed => new(_haContext, "light.z_esp32_c6_3_status_led");
}
...
public partial class MediaPlayerEntities
{
    ...
    ///<summary>65C755 Television</summary>
    public MediaPlayerEntity _65c755Television => new(_haContext, "media_player.65c755_television");
    ///<summary>ADB 65C755</summary>
    public MediaPlayerEntity Adb65c755 => new(_haContext, "media_player.adb_65c755");
    ///<summary>browser_mod_d407d4ae_c3026b27</summary>
    public MediaPlayerEntity BrowserModD407d4aeC3026b27 => new(_haContext, "media_player.browser_mod_d407d4ae_c3026b27");
    ///<summary>Guest</summary>
    public MediaPlayerEntity Guest => new(_haContext, "media_player.guest");
    ...
    ///<summary>Mipad Esphome Media Player</summary>
    public MediaPlayerEntity MipadEsphomeMediaPlayer => new(_haContext, "media_player.mipad_esphome_media_player");
    ///<summary>OnePlus13</summary>
    public MediaPlayerEntity Oneplus13 => new(_haContext, "media_player.oneplus13");
    ...
    ///<summary>Tapo Camera</summary>
    public MediaPlayerEntity TapoCamera => new(_haContext, "media_player.tapo_camera");
...
public partial class AiTaskEntities
{
    ...
    ///<summary>Arcee AI: Trinity Mini (free)</summary>
    public AiTaskEntity ArceeAiTrinityMiniFree => new(_haContext, "ai_task.arcee_ai_trinity_mini_free");
    ///<summary>DeepSeek: DeepSeek V3.1</summary>
    public AiTaskEntity DeepseekDeepseekV31 => new(_haContext, "ai_task.deepseek_deepseek_v3_1");
    ///<summary>Google AI Task</summary>
    public AiTaskEntity GoogleAiTask => new(_haContext, "ai_task.google_ai_task");
    ///<summary>Meta: Llama 3.3 70B Instruct (free)</summary>
    public AiTaskEntity MetaLlama3370bInstructFree => new(_haContext, "ai_task.meta_llama_3_3_70b_instruct_free");
    ///<summary>Mistral: Mistral Small 3.1 24B (free)</summary>
    public AiTaskEntity MistralMistralSmall3124bFree => new(_haContext, "ai_task.mistral_mistral_small_3_1_24b_free");
    ///<summary>NVIDIA: Nemotron 3 Super (free)</summary>
    public AiTaskEntity NvidiaNemotron3SuperFree => new(_haContext, "ai_task.nvidia_nemotron_3_super_free");
    ///<summary>OpenAI Codex Account 1 Codex AI Task</summary>
    public AiTaskEntity OpenaiCodexAccount1CodexAiTask => new(_haContext, "ai_task.openai_codex_account_1_codex_ai_task");
    ///<summary>OpenAI: gpt-oss-120b (free)</summary>
    public AiTaskEntity OpenaiGptOss120bFree => new(_haContext, "ai_task.openai_gpt_oss_120b_free");
    ///<summary>Qwen: Qwen3 Coder 480B A35B (free)</summary>
    public AiTaskEntity QwenQwen3Coder480bA35bFree => new(_haContext, "ai_task.qwen_qwen3_coder_480b_a35b_free");
}
...
public partial class AutomationEntities
{
    ...
    ///<summary>Daniel PC - Handle Shutdown Notification Actions</summary>
    public AutomationEntity DanielPcHandleShutdownNotificationActions => new(_haContext, "automation.daniel_pc_handle_shutdown_notification_actions");
    ///<summary>Daniel PC - Weekday Shutdown Prompt</summary>
    public AutomationEntity DanielPcWeekdayShutdownPrompt => new(_haContext, "automation.daniel_pc_weekday_shutdown_prompt");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>AdGuard Home Running</summary>
    public BinarySensorEntity AdguardHomeRunning => new(_haContext, "binary_sensor.adguard_home_running");
    ///<summary>Baby Camera Noise</summary>
    public BinarySensorEntity BabyCameraNoise => new(_haContext, "binary_sensor.baby_camera_noise");
    ...
    ///<summary>Browser Athena Online</summary>
    public BinarySensorEntity BrowserAthenaOnline => new(_haContext, "binary_sensor.browser_athena_online");
    ///<summary>Browser Daniel Online</summary>
    public BinarySensorEntity BrowserDanielOnline => new(_haContext, "binary_sensor.browser_daniel_online");
    ///<summary>Browser Guest Online</summary>
    public BinarySensorEntity BrowserGuestOnline => new(_haContext, "binary_sensor.browser_guest_online");
    ///<summary>browser_mod_d407d4ae_c3026b27</summary>
    public BinarySensorEntity BrowserModD407d4aeC3026b27 => new(_haContext, "binary_sensor.browser_mod_d407d4ae_c3026b27");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser dark mode</summary>
    public BinarySensorEntity BrowserModD407d4aeC3026b27BrowserDarkMode => new(_haContext, "binary_sensor.browser_mod_d407d4ae_c3026b27_browser_dark_mode");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser FullyKiosk</summary>
    public BinarySensorEntity BrowserModD407d4aeC3026b27BrowserFullykiosk => new(_haContext, "binary_sensor.browser_mod_d407d4ae_c3026b27_browser_fullykiosk");
    ///<summary>BudgetBakers Wallet BudgetBakers Wallet API Status</summary>
    public BinarySensorEntity BudgetbakersWalletBudgetbakersWalletApiStatus => new(_haContext, "binary_sensor.budgetbakers_wallet_budgetbakers_wallet_api_status");
    ///<summary>BudgetBakers Wallet Data Annotation Archived</summary>
    public BinarySensorEntity BudgetbakersWalletDataAnnotationArchived => new(_haContext, "binary_sensor.budgetbakers_wallet_data_annotation_archived");
    ///<summary>BudgetBakers Wallet GoTyme Archived</summary>
    public BinarySensorEntity BudgetbakersWalletGotymeArchived => new(_haContext, "binary_sensor.budgetbakers_wallet_gotyme_archived");
    ///<summary>BudgetBakers Wallet Maribank Archived</summary>
    public BinarySensorEntity BudgetbakersWalletMaribankArchived => new(_haContext, "binary_sensor.budgetbakers_wallet_maribank_archived");
    ///<summary>BudgetBakers Wallet Maya Archived</summary>
    public BinarySensorEntity BudgetbakersWalletMayaArchived => new(_haContext, "binary_sensor.budgetbakers_wallet_maya_archived");
    ///<summary>BudgetBakers Wallet SPaylater Archived</summary>
    public BinarySensorEntity BudgetbakersWalletSpaylaterArchived => new(_haContext, "binary_sensor.budgetbakers_wallet_spaylater_archived");
    ...
    ///<summary>Zigbee Contact Sensor (Bedroom) Door</summary>
    public BinarySensorEntity ContactSensorDoor => new(_haContext, "binary_sensor.contact_sensor_door");
    ///<summary>Bedroom Door</summary>
    public BinarySensorEntity ContactSensorDoorTmp => new(_haContext, "binary_sensor.contact_sensor_door_tmp");
    ///<summary>daniel-pc canleave</summary>
    public BinarySensorEntity DanielPcCanleave => new(_haContext, "binary_sensor.daniel_pc_canleave");
    ///<summary>daniel-pc canpair</summary>
    public BinarySensorEntity DanielPcCanpair => new(_haContext, "binary_sensor.daniel_pc_canpair");
    ///<summary>daniel-pc canreact</summary>
    public BinarySensorEntity DanielPcCanreact => new(_haContext, "binary_sensor.daniel_pc_canreact");
    ///<summary>daniel-pc canstopsharing</summary>
    public BinarySensorEntity DanielPcCanstopsharing => new(_haContext, "binary_sensor.daniel_pc_canstopsharing");
    ///<summary>daniel-pc cantoggleblur</summary>
    public BinarySensorEntity DanielPcCantoggleblur => new(_haContext, "binary_sensor.daniel_pc_cantoggleblur");
    ///<summary>daniel-pc cantogglechat</summary>
    public BinarySensorEntity DanielPcCantogglechat => new(_haContext, "binary_sensor.daniel_pc_cantogglechat");
    ///<summary>daniel-pc cantogglehand</summary>
    public BinarySensorEntity DanielPcCantogglehand => new(_haContext, "binary_sensor.daniel_pc_cantogglehand");
    ///<summary>daniel-pc cantogglemute</summary>
    public BinarySensorEntity DanielPcCantogglemute => new(_haContext, "binary_sensor.daniel_pc_cantogglemute");
    ///<summary>daniel-pc cantogglesharetray</summary>
    public BinarySensorEntity DanielPcCantogglesharetray => new(_haContext, "binary_sensor.daniel_pc_cantogglesharetray");
    ///<summary>daniel-pc cantogglevideo</summary>
    public BinarySensorEntity DanielPcCantogglevideo => new(_haContext, "binary_sensor.daniel_pc_cantogglevideo");
    ///<summary>daniel-pc hasunreadmessages</summary>
    public BinarySensorEntity DanielPcHasunreadmessages => new(_haContext, "binary_sensor.daniel_pc_hasunreadmessages");
    ///<summary>daniel-pc isinmeeting</summary>
    public BinarySensorEntity DanielPcIsinmeeting => new(_haContext, "binary_sensor.daniel_pc_isinmeeting");
    ///<summary>daniel-pc isrecordingon</summary>
    public BinarySensorEntity DanielPcIsrecordingon => new(_haContext, "binary_sensor.daniel_pc_isrecordingon");
    ///<summary>daniel-pc issharing</summary>
    public BinarySensorEntity DanielPcIssharing => new(_haContext, "binary_sensor.daniel_pc_issharing");
    ...
    ///<summary>daniel-pc teamsrunning</summary>
    public BinarySensorEntity DanielPcTeamsrunning => new(_haContext, "binary_sensor.daniel_pc_teamsrunning");
    ///<summary>Data Annotation Can Withdraw</summary>
    public BinarySensorEntity DataAnnotationCanWithdraw => new(_haContext, "binary_sensor.data_annotation_can_withdraw");
    ///<summary>Data Annotation In Progress Task</summary>
    public BinarySensorEntity DataAnnotationInProgressTask => new(_haContext, "binary_sensor.data_annotation_in_progress_task");
    ...
    ///<summary>Front Door Wrapper</summary>
    ...
    ///<summary>Front Door UI</summary>
    public BinarySensorEntity FrontDoorUiWrapper => new(_haContext, "binary_sensor.front_door_ui_wrapper");
    ///<summary>Guest</summary>
    public BinarySensorEntity Guest => new(_haContext, "binary_sensor.guest");
    ///<summary>Guest Browser dark mode</summary>
    public BinarySensorEntity GuestBrowserDarkMode => new(_haContext, "binary_sensor.guest_browser_dark_mode");
    ///<summary>Guest Browser FullyKiosk</summary>
    public BinarySensorEntity GuestBrowserFullykiosk => new(_haContext, "binary_sensor.guest_browser_fullykiosk");
    ///<summary>Guest Kiosk Mode</summary>
    public BinarySensorEntity GuestKioskMode => new(_haContext, "binary_sensor.guest_kiosk_mode");
    ...
    ///<summary>Hygrometer Tamper</summary>
    public BinarySensorEntity HygrometerTamper => new(_haContext, "binary_sensor.hygrometer_tamper");
    ///<summary>8.8.8.8 Internet</summary>
    public BinarySensorEntity Internet => new(_haContext, "binary_sensor.internet");
    ///<summary>iPhone Device Tracker IPhone</summary>
    public BinarySensorEntity Iphone => new(_haContext, "binary_sensor.iphone");
    ///<summary>Aenics iPhone Focus</summary>
    ...
    public BinarySensorEntity KitchenMotionSensorSmartPresenceUnfiltered2 => new(_haContext, "binary_sensor.kitchen_motion_sensor_smart_presence_unfiltered_2");
    ...
    ///<summary>KRZL 👸🏻 Kiosk Mode</summary>
    public BinarySensorEntity KrzlKioskMode => new(_haContext, "binary_sensor.krzl_kiosk_mode");
    ...
    ///<summary>bermuda_8c_ce_fd_a9_79_a6 Mi Watch BLE</summary>
    ...
    ///<summary>Mipad Esphome Face Detected</summary>
    public BinarySensorEntity MipadEsphomeFaceDetected => new(_haContext, "binary_sensor.mipad_esphome_face_detected");
    ///<summary>Mipad Esphome Redmi Watch 5 Active 7E31 Presence</summary>
    public BinarySensorEntity MipadEsphomeRedmiWatch5Active7e31Presence => new(_haContext, "binary_sensor.mipad_esphome_redmi_watch_5_active_7e31_presence");
    ///<summary>Mipad Esphome Server Status</summary>
    public BinarySensorEntity MipadEsphomeServerStatus => new(_haContext, "binary_sensor.mipad_esphome_server_status");
    ///<summary>OnePlus 13 BLE</summary>
    public BinarySensorEntity Oneplus13Ble => new(_haContext, "binary_sensor.oneplus_13_ble");
    ///<summary>OnePlus 13</summary>
    public BinarySensorEntity Oneplus13Wifi => new(_haContext, "binary_sensor.oneplus_13_wifi");
    ///<summary>OnePlus13</summary>
    public BinarySensorEntity Oneplus13 => new(_haContext, "binary_sensor.oneplus13");
    ///<summary>OnePlus13 Browser charging</summary>
    public BinarySensorEntity Oneplus13BrowserCharging => new(_haContext, "binary_sensor.oneplus13_browser_charging");
    ///<summary>OnePlus13 Browser dark mode</summary>
    public BinarySensorEntity Oneplus13BrowserDarkMode => new(_haContext, "binary_sensor.oneplus13_browser_dark_mode");
    ///<summary>OnePlus13 Browser FullyKiosk</summary>
    public BinarySensorEntity Oneplus13BrowserFullykiosk => new(_haContext, "binary_sensor.oneplus13_browser_fullykiosk");
    ...
    ///<summary>POCO F4 GT Work profile</summary>
    public BinarySensorEntity PocoF4GtWorkProfile => new(_haContext, "binary_sensor.poco_f4_gt_work_profile");
    ...
    ///<summary>Zigbee Contact Sensor (Bedroom) Battery</summary>
    public BinarySensorEntity ZigbeeContactSensorBedroomBatteryLow => new(_haContext, "binary_sensor.zigbee_contact_sensor_bedroom_battery_low");
    ///<summary>Zigbee Contact Sensor (Bedroom) Tamper</summary>
    public BinarySensorEntity ZigbeeContactSensorBedroomTamper => new(_haContext, "binary_sensor.zigbee_contact_sensor_bedroom_tamper");
...
public partial class ButtonEntities
{
    ...
    public ButtonEntity _65c755Identify2 => new(_haContext, "button.65c755_identify_2");
    ...
    public ButtonEntity AcLaunchApp => new(_haContext, "button.ac_launch_app");
    ///<summary>Baby Camera Calibrate</summary>
    public ButtonEntity BabyCameraCalibrate => new(_haContext, "button.baby_camera_calibrate");
    ///<summary>Baby Camera Format SD Card</summary>
    public ButtonEntity BabyCameraFormatSdCard => new(_haContext, "button.baby_camera_format_sd_card");
    ///<summary>Launch App</summary>
    public ButtonEntity BabyCameraLaunchApp => new(_haContext, "button.baby_camera_launch_app");
    ///<summary>Baby Camera Manual Alarm Start</summary>
    public ButtonEntity BabyCameraManualAlarmStart => new(_haContext, "button.baby_camera_manual_alarm_start");
    ///<summary>Baby Camera Manual Alarm Stop</summary>
    public ButtonEntity BabyCameraManualAlarmStop => new(_haContext, "button.baby_camera_manual_alarm_stop");
    ///<summary>Baby Camera Move Down</summary>
    public ButtonEntity BabyCameraMoveDown => new(_haContext, "button.baby_camera_move_down");
    ///<summary>Baby Camera Move Left</summary>
    public ButtonEntity BabyCameraMoveLeft => new(_haContext, "button.baby_camera_move_left");
    ///<summary>Baby Camera Move Right</summary>
    public ButtonEntity BabyCameraMoveRight => new(_haContext, "button.baby_camera_move_right");
    ///<summary>Baby Camera Move Up</summary>
    public ButtonEntity BabyCameraMoveUp => new(_haContext, "button.baby_camera_move_up");
    ///<summary>Baby Camera Reboot</summary>
    public ButtonEntity BabyCameraReboot => new(_haContext, "button.baby_camera_reboot");
    ///<summary>Baby Camera Sync Time</summary>
    public ButtonEntity BabyCameraSyncTime => new(_haContext, "button.baby_camera_sync_time");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity BathroomMotionSensorLaunchApp => new(_haContext, "button.bathroom_motion_sensor_launch_app");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity BedroomMotionSensorLaunchApp => new(_haContext, "button.bedroom_motion_sensor_launch_app");
    ...
    ///<summary>BudgetBakers Wallet BudgetBakers Wallet Sync Now</summary>
    public ButtonEntity BudgetbakersWalletBudgetbakersWalletSyncNow => new(_haContext, "button.budgetbakers_wallet_budgetbakers_wallet_sync_now");
    ...
    ///<summary>daniel-pc applause</summary>
    public ButtonEntity DanielPcApplause => new(_haContext, "button.daniel_pc_applause");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_Big_Picture_Mode</summary>
    public ButtonEntity DanielPcHassAgentBigPictureMode => new(_haContext, "button.daniel_pc_hass_agent_big_picture_mode");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_Display_Monitor</summary>
    public ButtonEntity DanielPcHassAgentDisplayMonitor => new(_haContext, "button.daniel_pc_hass_agent_display_monitor");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_Display_TV</summary>
    public ButtonEntity DanielPcHassAgentDisplayTv => new(_haContext, "button.daniel_pc_hass_agent_display_tv");
    ///<summary>DANIEL-PC_hass-agent Exit Steam</summary>
    public ButtonEntity DanielPcHassAgentExitSteam => new(_haContext, "button.daniel_pc_hass_agent_exit_steam");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_hass-agent_kill_edge</summary>
    public ButtonEntity DanielPcHassAgentKillChrome => new(_haContext, "button.daniel_pc_hass_agent_kill_chrome");
    ///<summary>Daniel PC Update Sensors</summary>
    public ButtonEntity DanielPcHassAgentPublishallsensors => new(_haContext, "button.daniel_pc_hass_agent_publishallsensors");
    ///<summary>DANIEL-PC_hass-agent Start MS Teams</summary>
    public ButtonEntity DanielPcHassAgentStartmsteams => new(_haContext, "button.daniel_pc_hass_agent_startmsteams");
    ///<summary>DANIEL-PC_hass-agent Update All ESP Devices</summary>
    public ButtonEntity DanielPcHassAgentUpdateAllEspDevices => new(_haContext, "button.daniel_pc_hass_agent_update_all_esp_devices");
    ///<summary>DANIEL-PC_hass-agent Update Motion ESP Devices</summary>
    public ButtonEntity DanielPcHassAgentUpdateMotionEspDevices => new(_haContext, "button.daniel_pc_hass_agent_update_motion_esp_devices");
    ///<summary>DANIEL-PC_hass-agent Update Plug ESP Devices</summary>
    public ButtonEntity DanielPcHassAgentUpdatePlugEspDevices => new(_haContext, "button.daniel_pc_hass_agent_update_plug_esp_devices");
    ///<summary>daniel-pc laugh</summary>
    public ButtonEntity DanielPcLaugh => new(_haContext, "button.daniel_pc_laugh");
    ///<summary>daniel-pc like</summary>
    public ButtonEntity DanielPcLike => new(_haContext, "button.daniel_pc_like");
    ///<summary>daniel-pc love</summary>
    public ButtonEntity DanielPcLove => new(_haContext, "button.daniel_pc_love");
    ...
    ///<summary>daniel-pc wow</summary>
    public ButtonEntity DanielPcWow => new(_haContext, "button.daniel_pc_wow");
    ///<summary>Data Annotation Claim Project - Learn to write amazing rationale commen…</summary>
    public ButtonEntity DataAnnotationClaimProjectLearnToWriteAmazingRationaleCommen2 => new(_haContext, "button.data_annotation_claim_project_learn_to_write_amazing_rationale_commen_2");
    ///<summary>Data Annotation Claim Project - Raccoon - SWE</summary>
    public ButtonEntity DataAnnotationClaimProjectRaccoonSwe => new(_haContext, "button.data_annotation_claim_project_raccoon_swe");
    ///<summary>Data Annotation Claim Project - Submit this task if you need the passke…</summary>
    public ButtonEntity DataAnnotationClaimProjectSubmitThisTaskIfYouNeedThePasske => new(_haContext, "button.data_annotation_claim_project_submit_this_task_if_you_need_the_passke");
    ///<summary>Data Annotation Clear Priority Cache</summary>
    public ButtonEntity DataAnnotationClearPriorityCache => new(_haContext, "button.data_annotation_clear_priority_cache");
    ///<summary>Data Annotation Rebuild Discovery</summary>
    public ButtonEntity DataAnnotationRebuildDiscovery => new(_haContext, "button.data_annotation_rebuild_discovery");
    ///<summary>Data Annotation Withdraw Funds</summary>
    public ButtonEntity DataAnnotationWithdrawFunds => new(_haContext, "button.data_annotation_withdraw_funds");
    ///<summary>Data Annotation Sync Now</summary>
    public ButtonEntity DataannotationDanielRodriguezDataannotationSyncNow => new(_haContext, "button.dataannotation_daniel_rodriguez_dataannotation_sync_now");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity DeskMotionSensorLaunchApp => new(_haContext, "button.desk_motion_sensor_launch_app");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity KitchenMotionSensorLaunchApp => new(_haContext, "button.kitchen_motion_sensor_launch_app");
    ...
    public ButtonEntity KitchenMotionSensorQueryParams2 => new(_haContext, "button.kitchen_motion_sensor_query_params_2");
    ///<summary>Kitchen Motion Sensor restart</summary>
    public ButtonEntity KitchenMotionSensorRestart2 => new(_haContext, "button.kitchen_motion_sensor_restart_2");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity LgWebosSmartTvLaunchApp => new(_haContext, "button.lg_webos_smart_tv_launch_app");
    ...
    ///<summary>Mipad Esphome Apply Audio Fix</summary>
    public ButtonEntity MipadEsphomeApplyAudioFix => new(_haContext, "button.mipad_esphome_apply_audio_fix");
    ///<summary>Mipad Esphome Kill App</summary>
    public ButtonEntity MipadEsphomeKillApp => new(_haContext, "button.mipad_esphome_kill_app");
    ///<summary>Mipad Esphome Manual Wake</summary>
    public ButtonEntity MipadEsphomeManualWake => new(_haContext, "button.mipad_esphome_manual_wake");
    ///<summary>Mipad Esphome Reboot Device</summary>
    public ButtonEntity MipadEsphomeRebootDevice => new(_haContext, "button.mipad_esphome_reboot_device");
    ///<summary>Mipad Esphome Refresh Web</summary>
    public ButtonEntity MipadEsphomeRefreshWeb => new(_haContext, "button.mipad_esphome_refresh_web");
    ///<summary>Mipad Esphome Restart Server</summary>
    public ButtonEntity MipadEsphomeRestartServer => new(_haContext, "button.mipad_esphome_restart_server");
    ///<summary>Mipad Esphome Restart Service</summary>
    public ButtonEntity MipadEsphomeRestartService => new(_haContext, "button.mipad_esphome_restart_service");
    ///<summary>Mipad Esphome Toggle Flashlight</summary>
    public ButtonEntity MipadEsphomeToggleFlashlight => new(_haContext, "button.mipad_esphome_toggle_flashlight");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity PantryMotionSensorLaunchApp => new(_haContext, "button.pantry_motion_sensor_launch_app");
    ...
    ///<summary>Restart ESP 32</summary>
    public ButtonEntity RestartEsp32 => new(_haContext, "button.restart_esp_32");
    ...
    ///<summary>Launch App</summary>
    public ButtonEntity SalaMotionSensorLaunchApp => new(_haContext, "button.sala_motion_sensor_launch_app");
    ...
    ///<summary>ThinkpadT14 Wake on LAN</summary>
    public ButtonEntity Thinkpadt14WakeOnLan => new(_haContext, "button.thinkpadt14_wake_on_lan");
    ///<summary>ThinkpadT14 Wake on WLAN</summary>
    public ButtonEntity Thinkpadt14WakeOnWlan => new(_haContext, "button.thinkpadt14_wake_on_wlan");
    ///<summary>Launch App</summary>
    public ButtonEntity TvBacklight3LiteLaunchApp => new(_haContext, "button.tv_backlight_3_lite_launch_app");
    ...
    public ButtonEntity XiaomiSmartAirFryerPro4lAirFryerPause => new(_haContext, "button.xiaomi_smart_air_fryer_pro_4l_air_fryer_pause");
    ///<summary>Xiaomi Smart Air Fryer Pro 4L  Air Fryer Start Program</summary>
    public ButtonEntity XiaomiSmartAirFryerPro4lAirFryerStartProgram => new(_haContext, "button.xiaomi_smart_air_fryer_pro_4l_air_fryer_start_program");
    ///<summary>Xiaomi Smart Air Fryer Pro 4L  Air Fryer Stop Program</summary>
    public ButtonEntity XiaomiSmartAirFryerPro4lAirFryerStopProgram => new(_haContext, "button.xiaomi_smart_air_fryer_pro_4l_air_fryer_stop_program");
...
public partial class ConversationEntities
{
    ...
    ///<summary>Codex Conversation Account 1 Codex Conversation</summary>
    public ConversationEntity CodexConversationAccount1CodexConversation => new(_haContext, "conversation.codex_conversation_account_1_codex_conversation");
...
public partial class DeviceTrackerEntities
{
    ...
    ///<summary>fa81a3f9-1759-480c-9a23-9defdca9aa14_100_40004</summary>
    public DeviceTrackerEntity Fa81a3f91759480c9a239defdca9aa1410040004 => new(_haContext, "device_tracker.fa81a3f9_1759_480c_9a23_9defdca9aa14_100_40004");
    ///<summary>Guest</summary>
    public DeviceTrackerEntity Guest => new(_haContext, "device_tracker.guest");
    ///<summary>Aenics</summary>
    public DeviceTrackerEntity Iphone => new(_haContext, "device_tracker.iphone");
    ///<summary>KRZL 👸🏻</summary>
    public DeviceTrackerEntity Krzl => new(_haContext, "device_tracker.krzl");
    ...
    ///<summary>OnePlus 13 Bermuda Tracker</summary>
    public DeviceTrackerEntity Oneplus13BermudaTracker => new(_haContext, "device_tracker.oneplus_13_bermuda_tracker");
    ///<summary>OnePlus13</summary>
    public DeviceTrackerEntity Oneplus13 => new(_haContext, "device_tracker.oneplus13");
...
public partial class EventEntities
{
    ...
    public EventEntity XiaomiSmartAirFryerPro4lAirFryerCompleted => new(_haContext, "event.xiaomi_smart_air_fryer_pro_4l_air_fryer_completed");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>ac_beeper</summary>
    public InputBooleanEntity AcBeeper => new(_haContext, "input_boolean.ac_beeper");
    ...
    ///<summary>Athena Home</summary>
    public InputBooleanEntity AthenaHome => new(_haContext, "input_boolean.athena_home");
    ///<summary>Baby Cam HD</summary>
    public InputBooleanEntity BabyCamHd => new(_haContext, "input_boolean.baby_cam_hd");
    ///<summary>Daniel Home</summary>
    public InputBooleanEntity DanielHome => new(_haContext, "input_boolean.daniel_home");
    ///<summary>Hide Header</summary>
    public InputBooleanEntity HideHeader => new(_haContext, "input_boolean.hide_header");
    ...
    ///<summary>netdaemon_home_automation_apps_security_security_app</summary>
    public InputBooleanEntity NetdaemonHomeAutomationAppsSecuritySecurityApp => new(_haContext, "input_boolean.netdaemon_home_automation_apps_security_security_app");
}
...
public partial class InputNumberEntities
{
    ...
    ///<summary>Wattage Unaccounted</summary>
    public InputNumberEntity WattageUnaccounted => new(_haContext, "input_number.wattage_unaccounted");
}
...
public partial class LockEntities
{
    ...
    ///<summary>Front Door Lock Wrapper</summary>
    public LockEntity LockWrapper => new(_haContext, "lock.lock_wrapper");
    ///<summary>Mipad Esphome Lock Display</summary>
    public LockEntity MipadEsphomeLockDisplay => new(_haContext, "lock.mipad_esphome_lock_display");
}
...
public partial class NumberEntities
{
    ...
    ///<summary>AC Temperature Step</summary>
    public NumberEntity AcTemperatureStep => new(_haContext, "number.ac_temperature_step");
    ///<summary>Baby Camera Microphone - Volume</summary>
    public NumberEntity BabyCameraMicrophoneVolume => new(_haContext, "number.baby_camera_microphone_volume");
    ///<summary>Baby Camera Motion Detection - Digital Sensitivity</summary>
    public NumberEntity BabyCameraMotionDetectionDigitalSensitivity => new(_haContext, "number.baby_camera_motion_detection_digital_sensitivity");
    ///<summary>Baby Camera Movement Angle</summary>
    public NumberEntity BabyCameraMovementAngle => new(_haContext, "number.baby_camera_movement_angle");
    ///<summary>Baby Camera Siren duration</summary>
    public NumberEntity BabyCameraSirenDuration => new(_haContext, "number.baby_camera_siren_duration");
    ///<summary>Baby Camera Siren volume</summary>
    public NumberEntity BabyCameraSirenVolume => new(_haContext, "number.baby_camera_siren_volume");
    ///<summary>Baby Camera Speaker - Volume</summary>
    public NumberEntity BabyCameraSpeakerVolume => new(_haContext, "number.baby_camera_speaker_volume");
    ///<summary>Baby Camera Spotlight Intensity</summary>
    public NumberEntity BabyCameraSpotlightIntensity => new(_haContext, "number.baby_camera_spotlight_intensity");
    ...
    public NumberEntity KitchenMotionSensorG0MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g0_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g0 still threshold</summary>
    public NumberEntity KitchenMotionSensorG0StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g0_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g1 move threshold</summary>
    public NumberEntity KitchenMotionSensorG1MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g1_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g1 still threshold</summary>
    public NumberEntity KitchenMotionSensorG1StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g1_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g2 move threshold</summary>
    public NumberEntity KitchenMotionSensorG2MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g2_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g2 still threshold</summary>
    public NumberEntity KitchenMotionSensorG2StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g2_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g3 move threshold</summary>
    public NumberEntity KitchenMotionSensorG3MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g3_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g3 still threshold</summary>
    public NumberEntity KitchenMotionSensorG3StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g3_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g4 move threshold</summary>
    public NumberEntity KitchenMotionSensorG4MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g4_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g4 still threshold</summary>
    public NumberEntity KitchenMotionSensorG4StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g4_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g5 move threshold</summary>
    public NumberEntity KitchenMotionSensorG5MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g5_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g5 still threshold</summary>
    public NumberEntity KitchenMotionSensorG5StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g5_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g6 move threshold</summary>
    public NumberEntity KitchenMotionSensorG6MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g6_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g6 still threshold</summary>
    public NumberEntity KitchenMotionSensorG6StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g6_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g7 move threshold</summary>
    public NumberEntity KitchenMotionSensorG7MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g7_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g7 still threshold</summary>
    public NumberEntity KitchenMotionSensorG7StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g7_still_threshold_2");
    ///<summary>Kitchen Motion Sensor g8 move threshold</summary>
    public NumberEntity KitchenMotionSensorG8MoveThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g8_move_threshold_2");
    ///<summary>Kitchen Motion Sensor g8 still threshold</summary>
    public NumberEntity KitchenMotionSensorG8StillThreshold2 => new(_haContext, "number.kitchen_motion_sensor_g8_still_threshold_2");
    ///<summary>Kitchen Motion Sensor light threshold</summary>
    public NumberEntity KitchenMotionSensorLightThreshold2 => new(_haContext, "number.kitchen_motion_sensor_light_threshold_2");
    ///<summary>Kitchen Motion Sensor max move distance gate</summary>
    public NumberEntity KitchenMotionSensorMaxMoveDistanceGate2 => new(_haContext, "number.kitchen_motion_sensor_max_move_distance_gate_2");
    ///<summary>Kitchen Motion Sensor max still distance gate</summary>
    public NumberEntity KitchenMotionSensorMaxStillDistanceGate2 => new(_haContext, "number.kitchen_motion_sensor_max_still_distance_gate_2");
    ...
    public NumberEntity KitchenMotionSensorTimeout2 => new(_haContext, "number.kitchen_motion_sensor_timeout_2");
    ...
    ///<summary>Mipad Esphome Bluetooth Away Delay</summary>
    public NumberEntity MipadEsphomeBluetoothAwayDelay => new(_haContext, "number.mipad_esphome_bluetooth_away_delay");
    ///<summary>Mipad Esphome Bluetooth RSSI Threshold</summary>
    public NumberEntity MipadEsphomeBluetoothRssiThreshold => new(_haContext, "number.mipad_esphome_bluetooth_rssi_threshold");
    ///<summary>Mipad Esphome Microphone Volume</summary>
    public NumberEntity MipadEsphomeMicrophoneVolume => new(_haContext, "number.mipad_esphome_microphone_volume");
    ///<summary>Mipad Esphome Screen Brightness</summary>
    public NumberEntity MipadEsphomeScreenBrightness => new(_haContext, "number.mipad_esphome_screen_brightness");
    ///<summary>OnePlus 13 Calibration Ref Power at 1m. 0 for default.</summary>
    public NumberEntity Oneplus13CalibrationRefPowerAt1m0ForDefault => new(_haContext, "number.oneplus_13_calibration_ref_power_at_1m_0_for_default");
    ...
    ///<summary>RGB Light Strip Smooth off</summary>
    public NumberEntity RgbLightStripSmoothOff => new(_haContext, "number.rgb_light_strip_smooth_off");
    ///<summary>RGB Light Strip Smooth on</summary>
    public NumberEntity RgbLightStripSmoothOn => new(_haContext, "number.rgb_light_strip_smooth_on");
    ...
    public NumberEntity XiaomiSmartAirFryerPro4lAirFryerOperatingTemperature => new(_haContext, "number.xiaomi_smart_air_fryer_pro_4l_air_fryer_operating_temperature");
    ///<summary>Xiaomi Smart Air Fryer Pro 4L  Air Fryer Operating Time</summary>
    public NumberEntity XiaomiSmartAirFryerPro4lAirFryerOperatingTime => new(_haContext, "number.xiaomi_smart_air_fryer_pro_4l_air_fryer_operating_time");
}
...
public partial class RemoteEntities
{
    ...
    ///<summary>ADB 65C755</summary>
    public RemoteEntity Adb65c755 => new(_haContext, "remote.adb_65c755");
    ///<summary>Living Room TV</summary>
...
public partial class ScriptEntities
{
    ...
    ///<summary>Ask PC Shutdown </summary>
    public ScriptEntity AskPcShutdown => new(_haContext, "script.ask_pc_shutdown");
    ///<summary>Launch HLK Radar Tool</summary>
    public ScriptEntity LaunchHlkRadarTool => new(_haContext, "script.launch_hlk_radar_tool");
    ///<summary>Set Poco F4 GT Alarm</summary>
    public ScriptEntity SetPocoF4GtAlarm => new(_haContext, "script.set_poco_f4_gt_alarm");
}
...
public partial class SelectEntities
{
    ...
    ///<summary>AC External Temperature Sensor</summary>
    public SelectEntity AcExternalTemperatureSensor => new(_haContext, "select.ac_external_temperature_sensor");
    ///<summary>AI Entities</summary>
    public SelectEntity AiEntities => new(_haContext, "select.ai_entities");
    ///<summary>Baby Camera Automatic Alarm</summary>
    public SelectEntity BabyCameraAutomaticAlarm => new(_haContext, "select.baby_camera_automatic_alarm");
    ///<summary>Baby Camera Automatic Reboot - Time</summary>
    public SelectEntity BabyCameraAutomaticRebootTime => new(_haContext, "select.baby_camera_automatic_reboot_time");
    ///<summary>Baby Camera Baby Cry Detection</summary>
    public SelectEntity BabyCameraBabyCryDetection => new(_haContext, "select.baby_camera_baby_cry_detection");
    ///<summary>Baby Camera Light Frequency</summary>
    public SelectEntity BabyCameraLightFrequency => new(_haContext, "select.baby_camera_light_frequency");
    ///<summary>Baby Camera Motion Detection</summary>
    public SelectEntity BabyCameraMotionDetection => new(_haContext, "select.baby_camera_motion_detection");
    ///<summary>Baby Camera Move to Preset</summary>
    public SelectEntity BabyCameraMoveToPreset => new(_haContext, "select.baby_camera_move_to_preset");
    ///<summary>Baby Camera Night Vision</summary>
    public SelectEntity BabyCameraNightVision => new(_haContext, "select.baby_camera_night_vision");
    ///<summary>Baby Camera Night Vision Switching</summary>
    public SelectEntity BabyCameraNightVisionSwitching => new(_haContext, "select.baby_camera_night_vision_switching");
    ///<summary>Baby Camera Patrol Mode</summary>
    public SelectEntity BabyCameraPatrolMode => new(_haContext, "select.baby_camera_patrol_mode");
    ///<summary>Baby Camera Person Detection</summary>
    public SelectEntity BabyCameraPersonDetection => new(_haContext, "select.baby_camera_person_detection");
    ///<summary>Baby Camera Siren Type</summary>
    public SelectEntity BabyCameraSirenType => new(_haContext, "select.baby_camera_siren_type");
    ///<summary>Baby Camera Spotlight on/off for</summary>
    public SelectEntity BabyCameraSpotlightOnOffFor => new(_haContext, "select.baby_camera_spotlight_on_off_for");
    ///<summary>Baby Camera Tamper Detection</summary>
    public SelectEntity BabyCameraTamperDetection => new(_haContext, "select.baby_camera_tamper_detection");
    ///<summary>Baby Camera Timezone</summary>
    public SelectEntity BabyCameraTimezone => new(_haContext, "select.baby_camera_timezone");
    ...
    ///<summary>Lasco Dual Plug Indicator light mode</summary>
    public SelectEntity BedroomLascoDualPlugIndicatorLightMode => new(_haContext, "select.bedroom_lasco_dual_plug_indicator_light_mode");
    ///<summary>Lasco Dual Plug Power-on behavior</summary>
    public SelectEntity BedroomLascoDualPlugPowerOnBehavior => new(_haContext, "select.bedroom_lasco_dual_plug_power_on_behavior");
    ...
    public SelectEntity KitchenMotionSensorBaudRate2 => new(_haContext, "select.kitchen_motion_sensor_baud_rate_2");
    ///<summary>Kitchen Motion Sensor distance resolution</summary>
    public SelectEntity KitchenMotionSensorDistanceResolution2 => new(_haContext, "select.kitchen_motion_sensor_distance_resolution_2");
    ///<summary>Kitchen Motion Sensor light function</summary>
    public SelectEntity KitchenMotionSensorLightFunction2 => new(_haContext, "select.kitchen_motion_sensor_light_function_2");
    ///<summary>Kitchen Motion Sensor out pin level</summary>
    public SelectEntity KitchenMotionSensorOutPinLevel2 => new(_haContext, "select.kitchen_motion_sensor_out_pin_level_2");
    ...
    ///<summary>Mipad Esphome Assistant</summary>
    public SelectEntity MipadEsphomeAssistant => new(_haContext, "select.mipad_esphome_assistant");
    ///<summary>Mipad Esphome Assistant 2</summary>
    public SelectEntity MipadEsphomeAssistant2 => new(_haContext, "select.mipad_esphome_assistant_2");
    ///<summary>Mipad Esphome Bluetooth Proxy Scan Mode</summary>
    public SelectEntity MipadEsphomeBluetoothProxyScanMode => new(_haContext, "select.mipad_esphome_bluetooth_proxy_scan_mode");
    ///<summary>Mipad Esphome Bluetooth Scan Power</summary>
    public SelectEntity MipadEsphomeBluetoothScanPower => new(_haContext, "select.mipad_esphome_bluetooth_scan_power");
    ///<summary>Mipad Esphome Finished speaking detection</summary>
    public SelectEntity MipadEsphomeFinishedSpeakingDetection => new(_haContext, "select.mipad_esphome_finished_speaking_detection");
    ///<summary>Mipad Esphome Wake word</summary>
    public SelectEntity MipadEsphomeWakeWord => new(_haContext, "select.mipad_esphome_wake_word");
    ///<summary>Mipad Esphome Wake word 2</summary>
    public SelectEntity MipadEsphomeWakeWord2 => new(_haContext, "select.mipad_esphome_wake_word_2");
    ///<summary>Lasco Dual Plug Indicator light mode</summary>
    public SelectEntity PantryLascoDualPlugIndicatorLightMode => new(_haContext, "select.pantry_lasco_dual_plug_indicator_light_mode");
    ///<summary>Lasco Dual Plug Power-on behavior</summary>
    public SelectEntity PantryLascoDualPlugPowerOnBehavior => new(_haContext, "select.pantry_lasco_dual_plug_power_on_behavior");
    ...
    ///<summary>S31 Plug 1 (Fridge) Fridge Power Monitor Startup</summary>
    public SelectEntity Sonoff1002163cb5Startup => new(_haContext, "select.sonoff_1002163cb5_startup");
    ///<summary>EWeLink Plug Bedroom 2 Bed Plug 2</summary>
    public SelectEntity Sonoff1002352c401 => new(_haContext, "select.sonoff_1002352c40_1");
    ///<summary>EWeLink Plug Sala 2 Laptop Plug</summary>
    public SelectEntity Sonoff1002380fe51 => new(_haContext, "select.sonoff_1002380fe5_1");
    ///<summary>EWeLink Plug Sala 1 Sala Stand Fan</summary>
    public SelectEntity Sonoff10023810231 => new(_haContext, "select.sonoff_1002381023_1");
    ///<summary>EWeLink Plug Bedroom 1 Bed Plug 1</summary>
    public SelectEntity Sonoff100238104e1 => new(_haContext, "select.sonoff_100238104e_1");
...
public partial class SensorEntities
{
    ...
    ///<summary>AdGuard Home Newest version</summary>
    public SensorEntity AdguardHomeNewestVersion => new(_haContext, "sensor.adguard_home_newest_version");
    ///<summary>AdGuard Home Version</summary>
    public SensorEntity AdguardHomeVersion => new(_haContext, "sensor.adguard_home_version");
    ...
    ///<summary>Baby Camera Last Automatic Reboot Time</summary>
    public SensorEntity BabyCameraLastAutomaticRebootTime => new(_haContext, "sensor.baby_camera_last_automatic_reboot_time");
    ///<summary>Baby Camera Link Type</summary>
    public SensorEntity BabyCameraLinkType => new(_haContext, "sensor.baby_camera_link_type");
    ///<summary>Baby Camera Network SSID</summary>
    public SensorEntity BabyCameraNetworkSsid => new(_haContext, "sensor.baby_camera_network_ssid");
    ///<summary>Baby Camera Recordings Synchronization</summary>
    public SensorEntity BabyCameraRecordingsSynchronization => new(_haContext, "sensor.baby_camera_recordings_synchronization");
    ...
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser ID</summary>
    public SensorEntity BrowserModD407d4aeC3026b27BrowserId => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_id");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser path</summary>
    public SensorEntity BrowserModD407d4aeC3026b27BrowserPath => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_path");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser user</summary>
    public SensorEntity BrowserModD407d4aeC3026b27BrowserUser => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_user");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser userAgent</summary>
    public SensorEntity BrowserModD407d4aeC3026b27BrowserUseragent => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_useragent");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser visibility</summary>
    public SensorEntity BrowserModD407d4aeC3026b27BrowserVisibility => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_visibility");
    ///<summary>browser_mod_d407d4ae_c3026b27 Panel</summary>
    public SensorEntity BrowserModD407d4aeC3026b27Panel => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_panel");
    ///<summary>BudgetBakers Wallet BPI Balance</summary>
    public SensorEntity BudgetbakersWalletBpiBalance => new(_haContext, "sensor.budgetbakers_wallet_bpi_balance");
    ///<summary>BudgetBakers Wallet BPI Last Record Date</summary>
    public SensorEntity BudgetbakersWalletBpiLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_bpi_last_record_date");
    ///<summary>BudgetBakers Wallet BudgetBakers Wallet Accounts</summary>
    public SensorEntity BudgetbakersWalletBudgetbakersWalletAccounts => new(_haContext, "sensor.budgetbakers_wallet_budgetbakers_wallet_accounts");
    ///<summary>BudgetBakers Wallet BudgetBakers Wallet Last Sync</summary>
    public SensorEntity BudgetbakersWalletBudgetbakersWalletLastSync => new(_haContext, "sensor.budgetbakers_wallet_budgetbakers_wallet_last_sync");
    ///<summary>BudgetBakers Wallet BudgetBakers Wallet Recent Transactions</summary>
    public SensorEntity BudgetbakersWalletBudgetbakersWalletRecentTransactions => new(_haContext, "sensor.budgetbakers_wallet_budgetbakers_wallet_recent_transactions");
    ///<summary>BudgetBakers Wallet Cash Balance</summary>
    public SensorEntity BudgetbakersWalletCashBalance => new(_haContext, "sensor.budgetbakers_wallet_cash_balance");
    ///<summary>BudgetBakers Wallet Cash Currency</summary>
    public SensorEntity BudgetbakersWalletCashCurrency => new(_haContext, "sensor.budgetbakers_wallet_cash_currency");
    ///<summary>BudgetBakers Wallet Data Annotation Balance</summary>
    public SensorEntity BudgetbakersWalletDataAnnotationBalance => new(_haContext, "sensor.budgetbakers_wallet_data_annotation_balance");
    ///<summary>BudgetBakers Wallet Data Annotation Currency</summary>
    public SensorEntity BudgetbakersWalletDataAnnotationCurrency => new(_haContext, "sensor.budgetbakers_wallet_data_annotation_currency");
    ///<summary>BudgetBakers Wallet Data Annotation Last Record Date</summary>
    public SensorEntity BudgetbakersWalletDataAnnotationLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_data_annotation_last_record_date");
    ///<summary>BudgetBakers Wallet Data Annotation Record Count</summary>
    public SensorEntity BudgetbakersWalletDataAnnotationRecordCount => new(_haContext, "sensor.budgetbakers_wallet_data_annotation_record_count");
    ///<summary>BudgetBakers Wallet GoTyme Balance</summary>
    public SensorEntity BudgetbakersWalletGotymeBalance => new(_haContext, "sensor.budgetbakers_wallet_gotyme_balance");
    ///<summary>BudgetBakers Wallet GoTyme Currency</summary>
    public SensorEntity BudgetbakersWalletGotymeCurrency => new(_haContext, "sensor.budgetbakers_wallet_gotyme_currency");
    ///<summary>BudgetBakers Wallet GoTyme Last Record Date</summary>
    public SensorEntity BudgetbakersWalletGotymeLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_gotyme_last_record_date");
    ///<summary>BudgetBakers Wallet GoTyme Record Count</summary>
    public SensorEntity BudgetbakersWalletGotymeRecordCount => new(_haContext, "sensor.budgetbakers_wallet_gotyme_record_count");
    ///<summary>BudgetBakers Wallet Maribank Balance</summary>
    public SensorEntity BudgetbakersWalletMaribankBalance => new(_haContext, "sensor.budgetbakers_wallet_maribank_balance");
    ///<summary>BudgetBakers Wallet Maribank Currency</summary>
    public SensorEntity BudgetbakersWalletMaribankCurrency => new(_haContext, "sensor.budgetbakers_wallet_maribank_currency");
    ///<summary>BudgetBakers Wallet Maribank Last Record Date</summary>
    public SensorEntity BudgetbakersWalletMaribankLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_maribank_last_record_date");
    ///<summary>BudgetBakers Wallet Maribank Record Count</summary>
    public SensorEntity BudgetbakersWalletMaribankRecordCount => new(_haContext, "sensor.budgetbakers_wallet_maribank_record_count");
    ///<summary>BudgetBakers Wallet Maya Balance</summary>
    public SensorEntity BudgetbakersWalletMayaBalance => new(_haContext, "sensor.budgetbakers_wallet_maya_balance");
    ///<summary>BudgetBakers Wallet Maya Currency</summary>
    public SensorEntity BudgetbakersWalletMayaCurrency => new(_haContext, "sensor.budgetbakers_wallet_maya_currency");
    ///<summary>BudgetBakers Wallet Maya Last Record Date</summary>
    public SensorEntity BudgetbakersWalletMayaLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_maya_last_record_date");
    ///<summary>BudgetBakers Wallet Maya Record Count</summary>
    public SensorEntity BudgetbakersWalletMayaRecordCount => new(_haContext, "sensor.budgetbakers_wallet_maya_record_count");
    ///<summary>BudgetBakers Wallet Meralco Balance</summary>
    public SensorEntity BudgetbakersWalletMeralcoBalance => new(_haContext, "sensor.budgetbakers_wallet_meralco_balance");
    ///<summary>BudgetBakers Wallet Meralco Last Record Date</summary>
    public SensorEntity BudgetbakersWalletMeralcoLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_meralco_last_record_date");
    ///<summary>BudgetBakers Wallet Metrobank Balance</summary>
    public SensorEntity BudgetbakersWalletMetrobankBalance => new(_haContext, "sensor.budgetbakers_wallet_metrobank_balance");
    ///<summary>BudgetBakers Wallet SeaBank Balance</summary>
    public SensorEntity BudgetbakersWalletSeabankBalance => new(_haContext, "sensor.budgetbakers_wallet_seabank_balance");
    ///<summary>BudgetBakers Wallet SeaBank Last Record Date</summary>
    public SensorEntity BudgetbakersWalletSeabankLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_seabank_last_record_date");
    ///<summary>BudgetBakers Wallet SPaylater Balance</summary>
    public SensorEntity BudgetbakersWalletSpaylaterBalance => new(_haContext, "sensor.budgetbakers_wallet_spaylater_balance");
    ///<summary>BudgetBakers Wallet SPaylater Currency</summary>
    public SensorEntity BudgetbakersWalletSpaylaterCurrency => new(_haContext, "sensor.budgetbakers_wallet_spaylater_currency");
    ///<summary>BudgetBakers Wallet SPaylater Last Record Date</summary>
    public SensorEntity BudgetbakersWalletSpaylaterLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_spaylater_last_record_date");
    ///<summary>BudgetBakers Wallet SPaylater Record Count</summary>
    public SensorEntity BudgetbakersWalletSpaylaterRecordCount => new(_haContext, "sensor.budgetbakers_wallet_spaylater_record_count");
    ///<summary>BudgetBakers Wallet Wise - AUD Balance</summary>
    public SensorEntity BudgetbakersWalletWiseAudBalance => new(_haContext, "sensor.budgetbakers_wallet_wise_aud_balance");
    ///<summary>BudgetBakers Wallet Wise - AUD Currency</summary>
    public SensorEntity BudgetbakersWalletWiseAudCurrency => new(_haContext, "sensor.budgetbakers_wallet_wise_aud_currency");
    ///<summary>BudgetBakers Wallet Wise - AUD Last Record Date</summary>
    public SensorEntity BudgetbakersWalletWiseAudLastRecordDate => new(_haContext, "sensor.budgetbakers_wallet_wise_aud_last_record_date");
    ///<summary>BudgetBakers Wallet Wise - AUD Record Count</summary>
    public SensorEntity BudgetbakersWalletWiseAudRecordCount => new(_haContext, "sensor.budgetbakers_wallet_wise_aud_record_count");
    ...
    ///<summary>DANIEL-PC Display switch</summary>
    public SensorEntity DanielPcDisplaySwitch => new(_haContext, "sensor.daniel_pc_display_switch");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_hass-agent_activewindow</summary>
    public SensorEntity DanielPcHassAgentActivewindow => new(_haContext, "sensor.daniel_pc_hass_agent_activewindow");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_hass-agent_incognito</summary>
    public SensorEntity DanielPcHassAgentIncognito => new(_haContext, "sensor.daniel_pc_hass_agent_incognito");
    ///<summary>DANIEL-PC_hass-agent DANIEL-PC_hass-agent_move_mouse_status</summary>
    public SensorEntity DanielPcHassAgentMoveMouseStatus => new(_haContext, "sensor.daniel_pc_hass_agent_move_mouse_status");
    ///<summary>DANIEL-PC_hass-agent MS Teams Active</summary>
    public SensorEntity DanielPcHassAgentMsteamsactive => new(_haContext, "sensor.daniel_pc_hass_agent_msteamsactive");
    ///<summary>DANIEL-PC_hass-agent TV Output</summary>
    public SensorEntity DanielPcHassAgentTvOutput => new(_haContext, "sensor.daniel_pc_hass_agent_tv_output");
    ///<summary>DANIEL-PC_hass-agent VPN Connected</summary>
    public SensorEntity DanielPcHassAgentVpnconnected => new(_haContext, "sensor.daniel_pc_hass_agent_vpnconnected");
    ///<summary>daniel-pc MS Teams Status</summary>
    public SensorEntity DanielPcMsTeamsStatus => new(_haContext, "sensor.daniel_pc_ms_teams_status");
    ...
    ///<summary>MS Teams Status</summary>
    public SensorEntity DanielPcTeamsstatus => new(_haContext, "sensor.daniel_pc_teamsstatus");
    ///<summary>Data Annotation Last Payout</summary>
    public SensorEntity DataAnnotationLastPayout => new(_haContext, "sensor.data_annotation_last_payout");
    ///<summary>Data Annotation Next Payout</summary>
    public SensorEntity DataAnnotationNextPayout => new(_haContext, "sensor.data_annotation_next_payout");
    ///<summary>Data Annotation Next Withdrawal</summary>
    public SensorEntity DataAnnotationNextWithdrawal => new(_haContext, "sensor.data_annotation_next_withdrawal");
    ///<summary>Data Annotation Project - Learn to write amazing rationale commen…</summary>
    public SensorEntity DataAnnotationProjectLearnToWriteAmazingRationaleCommen2 => new(_haContext, "sensor.data_annotation_project_learn_to_write_amazing_rationale_commen_2");
    ///<summary>Data Annotation Project - Raccoon - SWE</summary>
    public SensorEntity DataAnnotationProjectRaccoonSwe => new(_haContext, "sensor.data_annotation_project_raccoon_swe");
    ///<summary>Data Annotation Project - Submit this task if you need the passke…</summary>
    public SensorEntity DataAnnotationProjectSubmitThisTaskIfYouNeedThePasske => new(_haContext, "sensor.data_annotation_project_submit_this_task_if_you_need_the_passke");
    ///<summary>Data Annotation Profile</summary>
    public SensorEntity DataannotationDanielRodriguezDataannotationProfile => new(_haContext, "sensor.dataannotation_daniel_rodriguez_dataannotation_profile");
    ///<summary>Data Annotation Project Count</summary>
    public SensorEntity DataannotationDanielRodriguezDataannotationProjectCount => new(_haContext, "sensor.dataannotation_daniel_rodriguez_dataannotation_project_count");
    ///<summary>DataAnnotation Projects</summary>
    public SensorEntity DataannotationProjectsCount => new(_haContext, "sensor.dataannotation_projects_count");
    ...
    ///<summary>Forecast UV Index</summary>
    public SensorEntity ForecastUvIndex => new(_haContext, "sensor.forecast_uv_index");
    ...
    ///<summary>Guest App Version</summary>
    public SensorEntity GuestAppVersion => new(_haContext, "sensor.guest_app_version");
    ///<summary>Guest Audio Output</summary>
    public SensorEntity GuestAudioOutput => new(_haContext, "sensor.guest_audio_output");
    ///<summary>Guest Battery State</summary>
    public SensorEntity GuestBatteryState => new(_haContext, "sensor.guest_battery_state");
    ///<summary>Guest Browser ID</summary>
    public SensorEntity GuestBrowserId => new(_haContext, "sensor.guest_browser_id");
    ///<summary>Guest Browser path</summary>
    public SensorEntity GuestBrowserPath => new(_haContext, "sensor.guest_browser_path");
    ///<summary>Guest Browser user</summary>
    public SensorEntity GuestBrowserUser => new(_haContext, "sensor.guest_browser_user");
    ///<summary>Guest Browser userAgent</summary>
    public SensorEntity GuestBrowserUseragent => new(_haContext, "sensor.guest_browser_useragent");
    ///<summary>Guest Browser visibility</summary>
    public SensorEntity GuestBrowserVisibility => new(_haContext, "sensor.guest_browser_visibility");
    ///<summary>Guest BSSID</summary>
    public SensorEntity GuestBssid => new(_haContext, "sensor.guest_bssid");
    ///<summary>Guest Connection Type</summary>
    public SensorEntity GuestConnectionType => new(_haContext, "sensor.guest_connection_type");
    ///<summary>Guest Geocoded Location</summary>
    public SensorEntity GuestGeocodedLocation => new(_haContext, "sensor.guest_geocoded_location");
    ///<summary>Guest Kiosk Brightness</summary>
    public SensorEntity GuestKioskBrightness => new(_haContext, "sensor.guest_kiosk_brightness");
    ///<summary>Guest Kiosk Volume</summary>
    public SensorEntity GuestKioskVolume => new(_haContext, "sensor.guest_kiosk_volume");
    ///<summary>Guest Last Update Trigger</summary>
    public SensorEntity GuestLastUpdateTrigger => new(_haContext, "sensor.guest_last_update_trigger");
    ///<summary>Guest Location permission</summary>
    public SensorEntity GuestLocationPermission => new(_haContext, "sensor.guest_location_permission");
    ///<summary>Guest Panel</summary>
    public SensorEntity GuestPanel => new(_haContext, "sensor.guest_panel");
    ///<summary>Guest SIM 1</summary>
    public SensorEntity GuestSim1 => new(_haContext, "sensor.guest_sim_1");
    ///<summary>Guest SIM 2</summary>
    public SensorEntity GuestSim2 => new(_haContext, "sensor.guest_sim_2");
    ///<summary>Guest SSID</summary>
    public SensorEntity GuestSsid => new(_haContext, "sensor.guest_ssid");
    ///<summary>Latest version</summary>
    public SensorEntity HaLatestVersion => new(_haContext, "sensor.ha_latest_version");
    ...
    ///<summary>Aenics iPhone Activity</summary>
    public SensorEntity IphoneActivity => new(_haContext, "sensor.iphone_activity");
    ///<summary>Aenics iPhone App Version</summary>
    public SensorEntity IphoneAppVersion => new(_haContext, "sensor.iphone_app_version");
    ///<summary>Aenics iPhone Audio Output</summary>
    public SensorEntity IphoneAudioOutput => new(_haContext, "sensor.iphone_audio_output");
    ///<summary>Aenics iPhone Battery State</summary>
    public SensorEntity IphoneBatteryState => new(_haContext, "sensor.iphone_battery_state");
    ///<summary>Aenics iPhone BSSID</summary>
    public SensorEntity IphoneBssid => new(_haContext, "sensor.iphone_bssid");
    ///<summary>Aenics iPhone Connection Type</summary>
    public SensorEntity IphoneConnectionType => new(_haContext, "sensor.iphone_connection_type");
    ///<summary>Aenics iPhone Geocoded Location</summary>
    public SensorEntity IphoneGeocodedLocation => new(_haContext, "sensor.iphone_geocoded_location");
    ///<summary>Aenics iPhone Last Update Trigger</summary>
    public SensorEntity IphoneLastUpdateTrigger => new(_haContext, "sensor.iphone_last_update_trigger");
    ///<summary>Aenics iPhone Location permission</summary>
    public SensorEntity IphoneLocationPermission => new(_haContext, "sensor.iphone_location_permission");
    ///<summary>Aenics iPhone SIM 1</summary>
    public SensorEntity IphoneSim1 => new(_haContext, "sensor.iphone_sim_1");
    ///<summary>Aenics iPhone SIM 2</summary>
    public SensorEntity IphoneSim2 => new(_haContext, "sensor.iphone_sim_2");
    ///<summary>Aenics iPhone SSID</summary>
    public SensorEntity IphoneSsid => new(_haContext, "sensor.iphone_ssid");
    ///<summary>Kitchen Motion Sensor light</summary>
    public SensorEntity KitchenMotionSensorLight2 => new(_haContext, "sensor.kitchen_motion_sensor_light_2");
    ///<summary>Kitchen Motion Sensor Presence sensor mac address</summary>
    public SensorEntity KitchenMotionSensorPresenceSensorMacAddress2 => new(_haContext, "sensor.kitchen_motion_sensor_presence_sensor_mac_address_2");
    ///<summary>Kitchen Motion Sensor Presence sensor version</summary>
    public SensorEntity KitchenMotionSensorPresenceSensorVersion2 => new(_haContext, "sensor.kitchen_motion_sensor_presence_sensor_version_2");
    ///<summary>KRZL 👸🏻 App Version</summary>
    public SensorEntity KrzlAppVersion => new(_haContext, "sensor.krzl_app_version");
    ///<summary>KRZL 👸🏻 Audio Output</summary>
    public SensorEntity KrzlAudioOutput => new(_haContext, "sensor.krzl_audio_output");
    ///<summary>KRZL 👸🏻 Battery State</summary>
    public SensorEntity KrzlBatteryState => new(_haContext, "sensor.krzl_battery_state");
    ///<summary>KRZL 👸🏻 BSSID</summary>
    public SensorEntity KrzlBssid => new(_haContext, "sensor.krzl_bssid");
    ///<summary>KRZL 👸🏻 Connection Type</summary>
    public SensorEntity KrzlConnectionType => new(_haContext, "sensor.krzl_connection_type");
    ///<summary>KRZL 👸🏻 Geocoded Location</summary>
    public SensorEntity KrzlGeocodedLocation => new(_haContext, "sensor.krzl_geocoded_location");
    ///<summary>KRZL 👸🏻 Kiosk Brightness</summary>
    public SensorEntity KrzlKioskBrightness => new(_haContext, "sensor.krzl_kiosk_brightness");
    ///<summary>KRZL 👸🏻 Kiosk Volume</summary>
    public SensorEntity KrzlKioskVolume => new(_haContext, "sensor.krzl_kiosk_volume");
    ///<summary>KRZL 👸🏻 Last Update Trigger</summary>
    public SensorEntity KrzlLastUpdateTrigger => new(_haContext, "sensor.krzl_last_update_trigger");
    ///<summary>KRZL 👸🏻 Location permission</summary>
    public SensorEntity KrzlLocationPermission => new(_haContext, "sensor.krzl_location_permission");
    ///<summary>KRZL 👸🏻 SIM 1</summary>
    public SensorEntity KrzlSim1 => new(_haContext, "sensor.krzl_sim_1");
    ///<summary>KRZL 👸🏻 SIM 2</summary>
    public SensorEntity KrzlSim2 => new(_haContext, "sensor.krzl_sim_2");
    ///<summary>KRZL 👸🏻 SSID</summary>
    public SensorEntity KrzlSsid => new(_haContext, "sensor.krzl_ssid");
    ///<summary>Last Update Babycam Summary</summary>
    public SensorEntity LastUpdateBabycamSummary => new(_haContext, "sensor.last_update_babycam_summary");
    ...
    ///<summary>Meralco Electricity Rates Rate Trend</summary>
    public SensorEntity MeralcoElectricityRatesRateTrend => new(_haContext, "sensor.meralco_electricity_rates_rate_trend");
    ...
    ///<summary>MiPad Browser ID</summary>
    public SensorEntity MipadBrowserId => new(_haContext, "sensor.mipad_browser_id");
    ...
    ///<summary>Mipad Esphome Assistant Response</summary>
    public SensorEntity MipadEsphomeAssistantResponse => new(_haContext, "sensor.mipad_esphome_assistant_response");
    ///<summary>Mipad Esphome Connected Clients</summary>
    public SensorEntity MipadEsphomeConnectedClients => new(_haContext, "sensor.mipad_esphome_connected_clients");
    ///<summary>Mipad Esphome Female Count</summary>
    public SensorEntity MipadEsphomeFemaleCount => new(_haContext, "sensor.mipad_esphome_female_count");
    ///<summary>Mipad Esphome Fix Status</summary>
    public SensorEntity MipadEsphomeFixStatus => new(_haContext, "sensor.mipad_esphome_fix_status");
    ///<summary>Mipad Esphome Intent Launcher Status</summary>
    public SensorEntity MipadEsphomeIntentLauncherStatus => new(_haContext, "sensor.mipad_esphome_intent_launcher_status");
    ///<summary>Mipad Esphome Male Count</summary>
    public SensorEntity MipadEsphomeMaleCount => new(_haContext, "sensor.mipad_esphome_male_count");
    ///<summary>Mipad Esphome Serial Port</summary>
    public SensorEntity MipadEsphomeSerialPort => new(_haContext, "sensor.mipad_esphome_serial_port");
    ///<summary>Mipad Esphome TCP Port</summary>
    public SensorEntity MipadEsphomeTcpPort => new(_haContext, "sensor.mipad_esphome_tcp_port");
    ///<summary>Mipad Esphome Voice Command</summary>
    public SensorEntity MipadEsphomeVoiceCommand => new(_haContext, "sensor.mipad_esphome_voice_command");
    ///<summary>MiPad Panel</summary>
    public SensorEntity MipadPanel => new(_haContext, "sensor.mipad_panel");
    ///<summary>MiPad5 Battery state</summary>
    public SensorEntity Mipad5BatteryState => new(_haContext, "sensor.mipad5_battery_state");
    ///<summary>MiPad5 Charger type</summary>
    public SensorEntity Mipad5ChargerType => new(_haContext, "sensor.mipad5_charger_type");
    ///<summary>Home Assistant Numbers</summary>
    public SensorEntity Numbers => new(_haContext, "sensor.numbers");
    ///<summary>OnePlus 13 Area</summary>
    public SensorEntity Oneplus13Area => new(_haContext, "sensor.oneplus_13_area");
    ///<summary>OnePlus13 Battery state</summary>
    public SensorEntity Oneplus13BatteryState => new(_haContext, "sensor.oneplus13_battery_state");
    ///<summary>OnePlus13 BLE transmitter</summary>
    public SensorEntity Oneplus13BleTransmitter => new(_haContext, "sensor.oneplus13_ble_transmitter");
    ///<summary>OnePlus13 Browser ID</summary>
    public SensorEntity Oneplus13BrowserId => new(_haContext, "sensor.oneplus13_browser_id");
    ///<summary>OnePlus13 Browser path</summary>
    public SensorEntity Oneplus13BrowserPath => new(_haContext, "sensor.oneplus13_browser_path");
    ///<summary>OnePlus13 Browser user</summary>
    public SensorEntity Oneplus13BrowserUser => new(_haContext, "sensor.oneplus13_browser_user");
    ///<summary>OnePlus13 Browser userAgent</summary>
    public SensorEntity Oneplus13BrowserUseragent => new(_haContext, "sensor.oneplus13_browser_useragent");
    ///<summary>OnePlus13 Browser visibility</summary>
    public SensorEntity Oneplus13BrowserVisibility => new(_haContext, "sensor.oneplus13_browser_visibility");
    ///<summary>OnePlus13 Charger type</summary>
    public SensorEntity Oneplus13ChargerType => new(_haContext, "sensor.oneplus13_charger_type");
    ///<summary>OnePlus13 Last used app</summary>
    public SensorEntity Oneplus13LastUsedApp => new(_haContext, "sensor.oneplus13_last_used_app");
    ///<summary>OnePlus13 Network type</summary>
    public SensorEntity Oneplus13NetworkType => new(_haContext, "sensor.oneplus13_network_type");
    ///<summary>OnePlus13 Panel</summary>
    public SensorEntity Oneplus13Panel => new(_haContext, "sensor.oneplus13_panel");
    ///<summary>OnePlus13 Wi-Fi connection</summary>
    public SensorEntity Oneplus13WiFiConnection => new(_haContext, "sensor.oneplus13_wi_fi_connection");
    ...
    ///<summary>Pending Update Count</summary>
    public SensorEntity PendingUpdateCount => new(_haContext, "sensor.pending_update_count");
    ...
    ///<summary>POCO F4 GT Last notification</summary>
    public SensorEntity PocoF4GtLastNotification => new(_haContext, "sensor.poco_f4_gt_last_notification");
    ///<summary>POCO F4 GT Last removed notification</summary>
    public SensorEntity PocoF4GtLastRemovedNotification => new(_haContext, "sensor.poco_f4_gt_last_removed_notification");
    ...
    ///<summary>POCO F4 GT Public IP address</summary>
    public SensorEntity PocoF4GtPublicIpAddress => new(_haContext, "sensor.poco_f4_gt_public_ip_address");
    ///<summary>POCO F4 GT Screen brightness</summary>
    public SensorEntity PocoF4GtScreenBrightness => new(_haContext, "sensor.poco_f4_gt_screen_brightness");
    ///<summary>Real Debrid Download Link</summary>
    public SensorEntity RealDebridDownloadLink => new(_haContext, "sensor.real_debrid_download_link");
    ///<summary>Real Debrid Expiration</summary>
    public SensorEntity RealDebridExpiration => new(_haContext, "sensor.real_debrid_expiration");
    ///<summary>System Monitor Recent Entity Updates</summary>
    public SensorEntity RecentEntityUpdates => new(_haContext, "sensor.recent_entity_updates");
    ...
    public SensorEntity XiaomiSmartAirFryerPro4lAirFryerError => new(_haContext, "sensor.xiaomi_smart_air_fryer_pro_4l_air_fryer_error");
    ///<summary>Xiaomi Smart Air Fryer Pro 4L  Air Fryer Operating Status</summary>
    public SensorEntity XiaomiSmartAirFryerPro4lAirFryerOperatingStatus => new(_haContext, "sensor.xiaomi_smart_air_fryer_pro_4l_air_fryer_operating_status");
    ...
    ///<summary>Zigbee Contact Sensor (Bedroom) Linkquality</summary>
    public NumericSensorEntity _0xa4c1380c17faffffLinkquality => new(_haContext, "sensor.0xa4c1380c17faffff_linkquality");
    ///<summary>AC Outside Temperature</summary>
    public NumericSensorEntity AcOutsideTemperature => new(_haContext, "sensor.ac_outside_temperature");
    ///<summary>AC Room Humidity</summary>
    public NumericSensorEntity AcRoomHumidity2 => new(_haContext, "sensor.ac_room_humidity_2");
    ...
    ///<summary>AdGuard Home Average processing speed</summary>
    public NumericSensorEntity AdguardHomeAverageProcessingSpeed2 => new(_haContext, "sensor.adguard_home_average_processing_speed_2");
    ///<summary>AdGuard Home CPU percent</summary>
    public NumericSensorEntity AdguardHomeCpuPercent => new(_haContext, "sensor.adguard_home_cpu_percent");
    ...
    ///<summary>AdGuard Home DNS queries</summary>
    public NumericSensorEntity AdguardHomeDnsQueries2 => new(_haContext, "sensor.adguard_home_dns_queries_2");
    ...
    ///<summary>AdGuard Home DNS queries blocked</summary>
    public NumericSensorEntity AdguardHomeDnsQueriesBlocked2 => new(_haContext, "sensor.adguard_home_dns_queries_blocked_2");
    ...
    ///<summary>AdGuard Home DNS queries blocked ratio</summary>
    public NumericSensorEntity AdguardHomeDnsQueriesBlockedRatio2 => new(_haContext, "sensor.adguard_home_dns_queries_blocked_ratio_2");
    ///<summary>AdGuard Home Memory percent</summary>
    public NumericSensorEntity AdguardHomeMemoryPercent => new(_haContext, "sensor.adguard_home_memory_percent");
    ...
    ///<summary>AdGuard Home Parental control blocked</summary>
    public NumericSensorEntity AdguardHomeParentalControlBlocked2 => new(_haContext, "sensor.adguard_home_parental_control_blocked_2");
    ...
    ///<summary>AdGuard Home Safe browsing blocked</summary>
    public NumericSensorEntity AdguardHomeSafeBrowsingBlocked2 => new(_haContext, "sensor.adguard_home_safe_browsing_blocked_2");
    ...
    ///<summary>AdGuard Home Safe searches enforced</summary>
    public NumericSensorEntity AdguardHomeSafeSearchesEnforced2 => new(_haContext, "sensor.adguard_home_safe_searches_enforced_2");
    ///<summary>AUD to PHP Exchange Rate</summary>
    public NumericSensorEntity AudToPhpExchangeRate => new(_haContext, "sensor.aud_to_php_exchange_rate");
    ///<summary>Baby Camera RSSI</summary>
    public NumericSensorEntity BabyCameraRssi => new(_haContext, "sensor.baby_camera_rssi");
    ...
    ///<summary>Front Door Battery (Rechargable)</summary>
    public NumericSensorEntity BatteryRechargable => new(_haContext, "sensor.battery_rechargable");
    ///<summary>Lasco Dual Plug Current</summary>
    public NumericSensorEntity BedroomLascoDualPlugCurrent => new(_haContext, "sensor.bedroom_lasco_dual_plug_current");
    ///<summary>Lasco Dual Plug Power</summary>
    public NumericSensorEntity BedroomLascoDualPlugPower => new(_haContext, "sensor.bedroom_lasco_dual_plug_power");
    ///<summary>Lasco Dual Plug Total energy</summary>
    public NumericSensorEntity BedroomLascoDualPlugTotalEnergy => new(_haContext, "sensor.bedroom_lasco_dual_plug_total_energy");
    ///<summary>Lasco Dual Plug Voltage</summary>
    public NumericSensorEntity BedroomLascoDualPlugVoltage => new(_haContext, "sensor.bedroom_lasco_dual_plug_voltage");
    ...
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser height</summary>
    public NumericSensorEntity BrowserModD407d4aeC3026b27BrowserHeight => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_height");
    ///<summary>browser_mod_d407d4ae_c3026b27 Browser width</summary>
    public NumericSensorEntity BrowserModD407d4aeC3026b27BrowserWidth => new(_haContext, "sensor.browser_mod_d407d4ae_c3026b27_browser_width");
    ///<summary>Cloudflared CPU percent</summary>
    public NumericSensorEntity CloudflaredCpuPercent => new(_haContext, "sensor.cloudflared_cpu_percent");
    ///<summary>Cloudflared Memory percent</summary>
    public NumericSensorEntity CloudflaredMemoryPercent => new(_haContext, "sensor.cloudflared_memory_percent");
    ...
    ///<summary>Currency Exchange AUD to PHP</summary>
    public NumericSensorEntity CurrencyExchangeAudToPhp => new(_haContext, "sensor.currency_exchange_aud_to_php");
    ...
    ///<summary>DANIEL-PC Free disk space D:</summary>
    public NumericSensorEntity DanielPcFreeDiskSpaceD => new(_haContext, "sensor.daniel_pc_free_disk_space_d");
    ///<summary>DANIEL-PC Free disk space E:</summary>
    public NumericSensorEntity DanielPcFreeDiskSpaceE => new(_haContext, "sensor.daniel_pc_free_disk_space_e");
    ///<summary>DANIEL-PC Free disk space F:</summary>
    public NumericSensorEntity DanielPcFreeDiskSpaceF => new(_haContext, "sensor.daniel_pc_free_disk_space_f");
    ...
    public NumericSensorEntity DanielPcHassAgentCpuload => new(_haContext, "sensor.daniel_pc_hass_agent_cpuload");
    ...
    ///<summary>Data Annotation Available Funds</summary>
    public NumericSensorEntity DataAnnotationAvailableFunds => new(_haContext, "sensor.data_annotation_available_funds");
    ///<summary>Data Annotation Best Month</summary>
    public NumericSensorEntity DataAnnotationBestMonth => new(_haContext, "sensor.data_annotation_best_month");
    ///<summary>Data Annotation Pending Approval</summary>
    public NumericSensorEntity DataAnnotationPendingApproval => new(_haContext, "sensor.data_annotation_pending_approval");
    ///<summary>Data Annotation This Month</summary>
    public NumericSensorEntity DataAnnotationThisMonth => new(_haContext, "sensor.data_annotation_this_month");
    ///<summary>Data Annotation Total Earnings</summary>
    public NumericSensorEntity DataAnnotationTotalEarnings => new(_haContext, "sensor.data_annotation_total_earnings");
    ///<summary>Data Annotation Total Paid Out</summary>
    public NumericSensorEntity DataAnnotationTotalPaidOut => new(_haContext, "sensor.data_annotation_total_paid_out");
    ///<summary>Data Annotation Total Tasks</summary>
    public NumericSensorEntity DataAnnotationTotalTasks => new(_haContext, "sensor.data_annotation_total_tasks");
    ///<summary>Data Annotation USD to PHP Rate</summary>
    public NumericSensorEntity DataAnnotationUsdToPhpRate => new(_haContext, "sensor.data_annotation_usd_to_php_rate");
    ...
    ///<summary>Energy (Fan + Charger)</summary>
    ...
    ///<summary>Energy (Pressure Cooker)</summary>
    ...
    ///<summary>Smart Plug 2 Energy (Washing Machine)</summary>
    ...
    ///<summary>ESPHome Device Builder CPU percent</summary>
    public NumericSensorEntity EsphomeCpuPercent => new(_haContext, "sensor.esphome_cpu_percent");
    ///<summary>ESPHome Device Builder Memory percent</summary>
    public NumericSensorEntity EsphomeMemoryPercent => new(_haContext, "sensor.esphome_memory_percent");
    ///<summary>fa81a3f9-1759-480c-9a23-9defdca9aa14_100_40004 Estimated distance</summary>
    public NumericSensorEntity Fa81a3f91759480c9a239defdca9aa1410040004EstimatedDistance => new(_haContext, "sensor.fa81a3f9_1759_480c_9a23_9defdca9aa14_100_40004_estimated_distance");
    ...
    ///<summary>Front Door Signal strength</summary>
    public NumericSensorEntity FrontDoorSignalStrength => new(_haContext, "sensor.front_door_signal_strength");
    ///<summary>Guest Battery Level</summary>
    public NumericSensorEntity GuestBatteryLevel => new(_haContext, "sensor.guest_battery_level");
    ///<summary>Guest Browser height</summary>
    public NumericSensorEntity GuestBrowserHeight => new(_haContext, "sensor.guest_browser_height");
    ///<summary>Guest Browser width</summary>
    public NumericSensorEntity GuestBrowserWidth => new(_haContext, "sensor.guest_browser_width");
    ///<summary>Guest Storage</summary>
    public NumericSensorEntity GuestStorage => new(_haContext, "sensor.guest_storage");
    ///<summary>Hygrometer Battery</summary>
    public NumericSensorEntity HygrometerBattery => new(_haContext, "sensor.hygrometer_battery");
    ///<summary>Hygrometer Humidity</summary>
    public NumericSensorEntity HygrometerHumidity => new(_haContext, "sensor.hygrometer_humidity");
    ///<summary>Temperature (Living Room)</summary>
    public NumericSensorEntity HygrometerTemperature => new(_haContext, "sensor.hygrometer_temperature");
    ///<summary>Repairs Ignored</summary>
    public NumericSensorEntity IgnoredIssues => new(_haContext, "sensor.ignored_issues");
    ///<summary>Aenics iPhone Average Active Pace</summary>
    public NumericSensorEntity IphoneAverageActivePace => new(_haContext, "sensor.iphone_average_active_pace");
    ///<summary>Aenics iPhone Battery Level</summary>
    public NumericSensorEntity IphoneBatteryLevel => new(_haContext, "sensor.iphone_battery_level");
    ///<summary>Aenics iPhone Distance</summary>
    public NumericSensorEntity IphoneDistance => new(_haContext, "sensor.iphone_distance");
    ///<summary>Aenics iPhone Floors Ascended</summary>
    public NumericSensorEntity IphoneFloorsAscended => new(_haContext, "sensor.iphone_floors_ascended");
    ///<summary>Aenics iPhone Floors Descended</summary>
    public NumericSensorEntity IphoneFloorsDescended => new(_haContext, "sensor.iphone_floors_descended");
    ///<summary>Aenics iPhone Steps</summary>
    public NumericSensorEntity IphoneSteps => new(_haContext, "sensor.iphone_steps");
    ///<summary>Aenics iPhone Storage</summary>
    ...
    public NumericSensorEntity KitchenMotionSensorG0MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g0_move_energy_2");
    ///<summary>Kitchen Motion Sensor g0 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG0StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g0_still_energy_2");
    ///<summary>Kitchen Motion Sensor g1 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG1MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g1_move_energy_2");
    ///<summary>Kitchen Motion Sensor g1 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG1StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g1_still_energy_2");
    ///<summary>Kitchen Motion Sensor g2 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG2MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g2_move_energy_2");
    ///<summary>Kitchen Motion Sensor g2 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG2StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g2_still_energy_2");
    ///<summary>Kitchen Motion Sensor g3 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG3MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g3_move_energy_2");
    ///<summary>Kitchen Motion Sensor g3 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG3StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g3_still_energy_2");
    ///<summary>Kitchen Motion Sensor g4 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG4MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g4_move_energy_2");
    ///<summary>Kitchen Motion Sensor g4 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG4StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g4_still_energy_2");
    ///<summary>Kitchen Motion Sensor g5 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG5MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g5_move_energy_2");
    ///<summary>Kitchen Motion Sensor g5 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG5StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g5_still_energy_2");
    ///<summary>Kitchen Motion Sensor g6 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG6MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g6_move_energy_2");
    ///<summary>Kitchen Motion Sensor g6 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG6StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g6_still_energy_2");
    ///<summary>Kitchen Motion Sensor g7 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG7MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g7_move_energy_2");
    ///<summary>Kitchen Motion Sensor g7 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG7StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g7_still_energy_2");
    ///<summary>Kitchen Motion Sensor g8 move energy</summary>
    public NumericSensorEntity KitchenMotionSensorG8MoveEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g8_move_energy_2");
    ///<summary>Kitchen Motion Sensor g8 still energy</summary>
    public NumericSensorEntity KitchenMotionSensorG8StillEnergy2 => new(_haContext, "sensor.kitchen_motion_sensor_g8_still_energy_2");
    ///<summary>Kitchen Motion Sensor Occupancy Timeout</summary>
    public NumericSensorEntity KitchenMotionSensorOccupancyTimeout2 => new(_haContext, "sensor.kitchen_motion_sensor_occupancy_timeout_2");
    ///<summary>Kitchen Motion Sensor Uptime Sensor</summary>
    public NumericSensorEntity KitchenMotionSensorUptimeSensor2 => new(_haContext, "sensor.kitchen_motion_sensor_uptime_sensor_2");
    ///<summary>KRZL 👸🏻 Battery Level</summary>
    public NumericSensorEntity KrzlBatteryLevel => new(_haContext, "sensor.krzl_battery_level");
    ///<summary>KRZL 👸🏻 Storage</summary>
    public NumericSensorEntity KrzlStorage => new(_haContext, "sensor.krzl_storage");
    ...
    ///<summary>Meralco Electricity Rates Rate</summary>
    public NumericSensorEntity MeralcoElectricityRatesRate2 => new(_haContext, "sensor.meralco_electricity_rates_rate_2");
    ///<summary>Meralco Electricity Rates Rate Change</summary>
    public NumericSensorEntity MeralcoElectricityRatesRateChange => new(_haContext, "sensor.meralco_electricity_rates_rate_change");
    ///<summary>Meralco Electricity Rates Rate Change Percent</summary>
    public NumericSensorEntity MeralcoElectricityRatesRateChangePercent => new(_haContext, "sensor.meralco_electricity_rates_rate_change_percent");
    ...
    ///<summary>Mipad Charger Total energy</summary>
    public NumericSensorEntity MipadChargerTotalEnergy => new(_haContext, "sensor.mipad_charger_total_energy");
    ///<summary>Mipad Esphome Baudrate</summary>
    public NumericSensorEntity MipadEsphomeBaudrate => new(_haContext, "sensor.mipad_esphome_baudrate");
    ///<summary>Mipad Esphome Bytes Received</summary>
    public NumericSensorEntity MipadEsphomeBytesReceived => new(_haContext, "sensor.mipad_esphome_bytes_received");
    ///<summary>Mipad Esphome Bytes Sent</summary>
    public NumericSensorEntity MipadEsphomeBytesSent => new(_haContext, "sensor.mipad_esphome_bytes_sent");
    ///<summary>MiPad5 Battery level</summary>
    public NumericSensorEntity Mipad5BatteryLevel => new(_haContext, "sensor.mipad5_battery_level");
    ///<summary>OnePlus 13 Distance</summary>
    public NumericSensorEntity Oneplus13Distance => new(_haContext, "sensor.oneplus_13_distance");
    ///<summary>OnePlus13 Battery level</summary>
    public NumericSensorEntity Oneplus13BatteryLevel => new(_haContext, "sensor.oneplus13_battery_level");
    ///<summary>OnePlus13 Browser battery</summary>
    public NumericSensorEntity Oneplus13BrowserBattery => new(_haContext, "sensor.oneplus13_browser_battery");
    ///<summary>OnePlus13 Browser height</summary>
    public NumericSensorEntity Oneplus13BrowserHeight => new(_haContext, "sensor.oneplus13_browser_height");
    ///<summary>OnePlus13 Browser width</summary>
    public NumericSensorEntity Oneplus13BrowserWidth => new(_haContext, "sensor.oneplus13_browser_width");
    ///<summary>Lasco Dual Plug Current</summary>
    public NumericSensorEntity PantryLascoDualPlugCurrent => new(_haContext, "sensor.pantry_lasco_dual_plug_current");
    ///<summary>Lasco Dual Plug Power</summary>
    public NumericSensorEntity PantryLascoDualPlugPower => new(_haContext, "sensor.pantry_lasco_dual_plug_power");
    ///<summary>Lasco Dual Plug Total energy</summary>
    public NumericSensorEntity PantryLascoDualPlugTotalEnergy => new(_haContext, "sensor.pantry_lasco_dual_plug_total_energy");
    ///<summary>Lasco Dual Plug Voltage</summary>
    public NumericSensorEntity PantryLascoDualPlugVoltage => new(_haContext, "sensor.pantry_lasco_dual_plug_voltage");
    ...
    ///<summary>Real Debrid Remaining Days</summary>
    public NumericSensorEntity RealDebridRemainingDays => new(_haContext, "sensor.real_debrid_remaining_days");
    ...
    ///<summary>Rice Cooker Total energy</summary>
    public NumericSensorEntity RiceCookerTotalEnergy => new(_haContext, "sensor.rice_cooker_total_energy");
    ...
    public NumericSensorEntity SystemMonitorDiskFree => new(_haContext, "sensor.system_monitor_disk_free");
    ...
    ///<summary>AC Temperature (Bedroom)</summary>
    public NumericSensorEntity TemperatureBedroom => new(_haContext, "sensor.temperature_bedroom");
    ///<summary>Temperature (Weather)</summary>
    public NumericSensorEntity TemperatureWeather => new(_haContext, "sensor.temperature_weather");
    ///<summary>USD to PHP Exchange Rate</summary>
    public NumericSensorEntity UsdToPhpExchangeRate => new(_haContext, "sensor.usd_to_php_exchange_rate");
    ...
    ///<summary>Water Dispenser Total energy</summary>
    public NumericSensorEntity WaterDispenserTotalEnergy => new(_haContext, "sensor.water_dispenser_total_energy");
    ///<summary>Water Dispenser Wattage</summary>
    public NumericSensorEntity WaterDispenserWattage => new(_haContext, "sensor.water_dispenser_wattage");
    ...
    ///<summary>Projector Wattage (Projector)</summary>
    ...
    public NumericSensorEntity WattageTclTv => new(_haContext, "sensor.wattage_tcl_tv");
    ///<summary>Wattage (Total)</summary>
    public NumericSensorEntity WattageTotal => new(_haContext, "sensor.wattage_total");
    ...
    public NumericSensorEntity XiaomiSmartAirFryerPro4lAirFryerTimeRemaining => new(_haContext, "sensor.xiaomi_smart_air_fryer_pro_4l_air_fryer_time_remaining");
    ///<summary>Zigbee Contact Sensor (Bedroom) Battery</summary>
    public NumericSensorEntity ZigbeeContactSensorBedroomBattery => new(_haContext, "sensor.zigbee_contact_sensor_bedroom_battery");
    ///<summary>Zigbee Contact Sensor (Bedroom) Voltage</summary>
    public NumericSensorEntity ZigbeeContactSensorBedroomVoltage => new(_haContext, "sensor.zigbee_contact_sensor_bedroom_voltage");
    ///<summary>Zigbee Hygrometer Battery</summary>
    public NumericSensorEntity ZigbeeHygrometerBattery => new(_haContext, "sensor.zigbee_hygrometer_battery");
    ///<summary>Zigbee Hygrometer Humidity</summary>
    public NumericSensorEntity ZigbeeHygrometerHumidity => new(_haContext, "sensor.zigbee_hygrometer_humidity");
    ///<summary>Zigbee Hygrometer Temperature</summary>
    public NumericSensorEntity ZigbeeHygrometerTemperature => new(_haContext, "sensor.zigbee_hygrometer_temperature");
    ///<summary>Zigbee Hygrometer Voltage</summary>
    public NumericSensorEntity ZigbeeHygrometerVoltage => new(_haContext, "sensor.zigbee_hygrometer_voltage");
}
...
public partial class SwitchEntities
{
    ...
    public SwitchEntity _65c755Mute2 => new(_haContext, "switch.65c755_mute_2");
    ///<summary>AC 8°C Heat</summary>
    public SwitchEntity Ac8degcHeat => new(_haContext, "switch.ac_8degc_heat");
    ///<summary>AC Air</summary>
    public SwitchEntity AcAir => new(_haContext, "switch.ac_air");
    ///<summary>AC Anti Direct Blow</summary>
    public SwitchEntity AcAntiDirectBlow => new(_haContext, "switch.ac_anti_direct_blow");
    ///<summary>AC Auto Light</summary>
    public SwitchEntity AcAutoLight => new(_haContext, "switch.ac_auto_light");
    ///<summary>AC Auto X-Fan</summary>
    public SwitchEntity AcAutoXFan => new(_haContext, "switch.ac_auto_x_fan");
    ///<summary>AC Automation</summary>
    public SwitchEntity AcAutomation => new(_haContext, "switch.ac_automation");
    ///<summary>AC Beeper</summary>
    public SwitchEntity AcBeeper => new(_haContext, "switch.ac_beeper");
    ///<summary>AC Health</summary>
    public SwitchEntity AcHealth => new(_haContext, "switch.ac_health");
    ///<summary>AC Light Sensor</summary>
    public SwitchEntity AcLightSensor => new(_haContext, "switch.ac_light_sensor");
    ///<summary>AC Lights</summary>
    public SwitchEntity AcLights => new(_haContext, "switch.ac_lights");
    ///<summary>AC Power Save</summary>
    public SwitchEntity AcPowerSave => new(_haContext, "switch.ac_power_save");
    ///<summary>AC Sleep</summary>
    public SwitchEntity AcSleep => new(_haContext, "switch.ac_sleep");
    ///<summary>AC Swing Mode</summary>
    public SwitchEntity AcSwingMode => new(_haContext, "switch.ac_swing_mode");
    ///<summary>AC X-Fan</summary>
    public SwitchEntity AcXFan => new(_haContext, "switch.ac_x_fan");
    ...
    ///<summary>AdGuard Home Filtering</summary>
    public SwitchEntity AdguardHomeFiltering2 => new(_haContext, "switch.adguard_home_filtering_2");
    ...
    ///<summary>AdGuard Home Parental control</summary>
    public SwitchEntity AdguardHomeParentalControl2 => new(_haContext, "switch.adguard_home_parental_control_2");
    ...
    ///<summary>AdGuard Home Protection</summary>
    public SwitchEntity AdguardHomeProtection2 => new(_haContext, "switch.adguard_home_protection_2");
    ...
    ///<summary>AdGuard Home Query log</summary>
    public SwitchEntity AdguardHomeQueryLog2 => new(_haContext, "switch.adguard_home_query_log_2");
    ...
    ///<summary>AdGuard Home Safe browsing</summary>
    public SwitchEntity AdguardHomeSafeBrowsing2 => new(_haContext, "switch.adguard_home_safe_browsing_2");
    ...
    ///<summary>AdGuard Home Safe search</summary>
    public SwitchEntity AdguardHomeSafeSearch2 => new(_haContext, "switch.adguard_home_safe_search_2");
    ///<summary>Xiaomi Smart Air Fryer Pro 4L Air Fryer Toggle</summary>
    public SwitchEntity AirFryerToggle => new(_haContext, "switch.air_fryer_toggle");
    ///<summary>Auto Calibrate</summary>
    public SwitchEntity AutoCalibrate => new(_haContext, "switch.auto_calibrate");
    ///<summary>Baby Camera Auto Track</summary>
    public SwitchEntity BabyCameraAutoTrack => new(_haContext, "switch.baby_camera_auto_track");
    ///<summary>Baby Camera Automatic Reboot</summary>
    public SwitchEntity BabyCameraAutomaticReboot => new(_haContext, "switch.baby_camera_automatic_reboot");
    ///<summary>Baby Camera Automatically Upgrade Firmware</summary>
    public SwitchEntity BabyCameraAutomaticallyUpgradeFirmware => new(_haContext, "switch.baby_camera_automatically_upgrade_firmware");
    ///<summary>Baby Camera Diagnose Mode</summary>
    public SwitchEntity BabyCameraDiagnoseMode => new(_haContext, "switch.baby_camera_diagnose_mode");
    ///<summary>Baby Camera Flip</summary>
    public SwitchEntity BabyCameraFlip => new(_haContext, "switch.baby_camera_flip");
    ///<summary>Baby Camera Indicator LED</summary>
    public SwitchEntity BabyCameraIndicatorLed => new(_haContext, "switch.baby_camera_indicator_led");
    ///<summary>Baby Camera Lens Distortion Correction</summary>
    public SwitchEntity BabyCameraLensDistortionCorrection => new(_haContext, "switch.baby_camera_lens_distortion_correction");
    ///<summary>Baby Camera Media Sync</summary>
    public SwitchEntity BabyCameraMediaSync => new(_haContext, "switch.baby_camera_media_sync");
    ///<summary>Baby Camera Microphone - Mute</summary>
    public SwitchEntity BabyCameraMicrophoneMute => new(_haContext, "switch.baby_camera_microphone_mute");
    ///<summary>Baby Camera Microphone - Noise Cancellation</summary>
    public SwitchEntity BabyCameraMicrophoneNoiseCancellation => new(_haContext, "switch.baby_camera_microphone_noise_cancellation");
    ///<summary>Baby Camera Notifications</summary>
    public SwitchEntity BabyCameraNotifications => new(_haContext, "switch.baby_camera_notifications");
    ///<summary>Baby Camera Privacy</summary>
    public SwitchEntity BabyCameraPrivacy => new(_haContext, "switch.baby_camera_privacy");
    ///<summary>Baby Camera Privacy Zones</summary>
    public SwitchEntity BabyCameraPrivacyZones => new(_haContext, "switch.baby_camera_privacy_zones");
    ///<summary>Baby Camera Record Audio</summary>
    public SwitchEntity BabyCameraRecordAudio => new(_haContext, "switch.baby_camera_record_audio");
    ///<summary>Baby Camera Record to SD Card</summary>
    public SwitchEntity BabyCameraRecordToSdCard => new(_haContext, "switch.baby_camera_record_to_sd_card");
    ///<summary>Baby Camera Rich Notifications</summary>
    public SwitchEntity BabyCameraRichNotifications => new(_haContext, "switch.baby_camera_rich_notifications");
    ///<summary>Baby Camera Smart Track - Baby</summary>
    public SwitchEntity BabyCameraSmartTrackBaby => new(_haContext, "switch.baby_camera_smart_track_baby");
    ///<summary>Baby Camera Smart Track - People</summary>
    public SwitchEntity BabyCameraSmartTrackPeople => new(_haContext, "switch.baby_camera_smart_track_people");
    ///<summary>Baby Camera Smart Track - Pet</summary>
    public SwitchEntity BabyCameraSmartTrackPet => new(_haContext, "switch.baby_camera_smart_track_pet");
    ///<summary>Baby Camera Smart Track - Vehicle</summary>
    public SwitchEntity BabyCameraSmartTrackVehicle => new(_haContext, "switch.baby_camera_smart_track_vehicle");
    ///<summary>Baby Camera Speaker</summary>
    public SwitchEntity BabyCameraSpeaker => new(_haContext, "switch.baby_camera_speaker");
    ///<summary>Baby Camera Trigger alarm on motion_detection</summary>
    public SwitchEntity BabyCameraTriggerAlarmOnMotionDetection => new(_haContext, "switch.baby_camera_trigger_alarm_on_motion_detection");
    ///<summary>Baby Camera Trigger alarm on people_detection</summary>
    public SwitchEntity BabyCameraTriggerAlarmOnPeopleDetection => new(_haContext, "switch.baby_camera_trigger_alarm_on_people_detection");
    ///<summary>Baby Camera Trigger alarm on sound_detection</summary>
    public SwitchEntity BabyCameraTriggerAlarmOnSoundDetection => new(_haContext, "switch.baby_camera_trigger_alarm_on_sound_detection");
    ///<summary>Baby Camera Trigger alarm on tamper_detection</summary>
    public SwitchEntity BabyCameraTriggerAlarmOnTamperDetection => new(_haContext, "switch.baby_camera_trigger_alarm_on_tamper_detection");
    ...
    public SwitchEntity BedroomLascoDualPlugCharger => new(_haContext, "switch.bedroom_lasco_dual_plug_charger");
    ///<summary>Lasco Dual Plug Child lock</summary>
    public SwitchEntity BedroomLascoDualPlugChildLock => new(_haContext, "switch.bedroom_lasco_dual_plug_child_lock");
    ...
    ///<summary>DANIEL-PC_hass-agent Big Picture Mode</summary>
    public SwitchEntity BigPictureMode => new(_haContext, "switch.big_picture_mode");
    ///<summary>button-card Pre-release</summary>
    public SwitchEntity ButtonCardPreRelease => new(_haContext, "switch.button_card_pre_release");
    ...
    ///<summary>Xiaomi Smart Air Purifier 4 Compact Clean Air</summary>
    ...
    ///<summary>daniel-pc isbackgroundblurred</summary>
    public SwitchEntity DanielPcIsbackgroundblurred => new(_haContext, "switch.daniel_pc_isbackgroundblurred");
    ///<summary>daniel-pc ishandraised</summary>
    public SwitchEntity DanielPcIshandraised => new(_haContext, "switch.daniel_pc_ishandraised");
    ///<summary>daniel-pc ismuted</summary>
    public SwitchEntity DanielPcIsmuted => new(_haContext, "switch.daniel_pc_ismuted");
    ///<summary>daniel-pc isvideoon</summary>
    public SwitchEntity DanielPcIsvideoon => new(_haContext, "switch.daniel_pc_isvideoon");
    ///<summary>Data Annotation Auto Accept</summary>
    public SwitchEntity DataAnnotationAutoAccept => new(_haContext, "switch.data_annotation_auto_accept");
    ///<summary>Data Annotation Auto Withdraw</summary>
    public SwitchEntity DataAnnotationAutoWithdraw => new(_haContext, "switch.data_annotation_auto_withdraw");
    ///<summary>Data Annotation Claim Projects Locked</summary>
    public SwitchEntity DataAnnotationClaimProjectsLocked => new(_haContext, "switch.data_annotation_claim_projects_locked");
    ///<summary>Data Annotation Currency to PHP</summary>
    public SwitchEntity DataAnnotationCurrencyToPhp => new(_haContext, "switch.data_annotation_currency_to_php");
    ///<summary>Data Annotation Fast Polling</summary>
    public SwitchEntity DataAnnotationFastPolling => new(_haContext, "switch.data_annotation_fast_polling");
    ///<summary>Data Annotation Notifications</summary>
    public SwitchEntity DataAnnotationNotifications => new(_haContext, "switch.data_annotation_notifications");
    ///<summary>Data Annotation Withdraw Locked</summary>
    public SwitchEntity DataAnnotationWithdrawLocked => new(_haContext, "switch.data_annotation_withdraw_locked");
    ...
    ///<summary>LG webOS Smart TV Display PC</summary>
    ...
    public SwitchEntity KitchenMotionSensorControlBluetooth2 => new(_haContext, "switch.kitchen_motion_sensor_control_bluetooth_2");
    ...
    ///<summary>LG webOS Smart TV Lg Screen</summary>
    public SwitchEntity LgScreen => new(_haContext, "switch.lg_screen");
    ///<summary>LG webOS Smart TV LG TV</summary>
    public SwitchEntity LgTv => new(_haContext, "switch.lg_tv");
    ///<summary>LG webOS Smart TV LG TV Motion Sensor</summary>
    ...
    ///<summary>Baby Camera Preset Patrol Mode</summary>
    public SwitchEntity LivingRoomBabyCameraPresetPatrolMode => new(_haContext, "switch.living_room_baby_camera_preset_patrol_mode");
    ...
    ///<summary>Lovelace Display Laptop</summary>
    public SwitchEntity LovelaceDisplayLaptop => new(_haContext, "switch.lovelace_display_laptop");
    ///<summary>Material You Theme - A Fully Featured Implementation of Material Design 3 Pre-release</summary>
    public SwitchEntity MaterialRoundedThemeBasedOnMaterialYouByGoogleOnAndroidPreRelease => new(_haContext, "switch.material_rounded_theme_based_on_material_you_by_google_on_android_pre_release");
    ...
    ///<summary>Mipad Esphome Baby Cam</summary>
    public SwitchEntity MipadEsphomeBabyCam => new(_haContext, "switch.mipad_esphome_baby_cam");
    ///<summary>Mipad Esphome Browser Display</summary>
    public SwitchEntity MipadEsphomeBrowserDisplay => new(_haContext, "switch.mipad_esphome_browser_display");
    ///<summary>Mipad Esphome Mute Microphone</summary>
    public SwitchEntity MipadEsphomeMuteMicrophone => new(_haContext, "switch.mipad_esphome_mute_microphone");
    ///<summary>Mipad Esphome Screen Toggle</summary>
    public SwitchEntity MipadEsphomeScreenToggle => new(_haContext, "switch.mipad_esphome_screen_toggle");
    ///<summary>Mipad Esphome Screensaver Display</summary>
    public SwitchEntity MipadEsphomeScreensaverDisplay => new(_haContext, "switch.mipad_esphome_screensaver_display");
    ///<summary>Mipad Esphome Start Recording</summary>
    public SwitchEntity MipadEsphomeStartRecording => new(_haContext, "switch.mipad_esphome_start_recording");
    ///<summary>Mipad Esphome Wake Sound</summary>
    public SwitchEntity MipadEsphomeWakeSound => new(_haContext, "switch.mipad_esphome_wake_sound");
    ///<summary>Motion Sensors</summary>
    public SwitchEntity MotionSensors => new(_haContext, "switch.motion_sensors");
    ///<summary>Baby Camera Night Vision</summary>
    public SwitchEntity NightVision => new(_haContext, "switch.night_vision");
    ///<summary>Lasco Dual Plug Child lock</summary>
    public SwitchEntity PantryLascoDualPlugChildLock => new(_haContext, "switch.pantry_lasco_dual_plug_child_lock");
    ///<summary>Lasco Dual Plug Socket 1</summary>
    public SwitchEntity PantryLascoDualPlugSocket1 => new(_haContext, "switch.pantry_lasco_dual_plug_socket_1");
    ///<summary>Lasco Dual Plug Socket 2</summary>
    public SwitchEntity PantryLascoDualPlugSocket2 => new(_haContext, "switch.pantry_lasco_dual_plug_socket_2");
    ...
    public SwitchEntity PcOutputTv => new(_haContext, "switch.pc_output_tv");
    ...
    public SwitchEntity Sonoff100238104e1Original => new(_haContext, "switch.sonoff_100238104e_1_original");
    ...
    ///<summary>MiPad5 Tablet Light</summary>
    public SwitchEntity TabletLight => new(_haContext, "switch.tablet_light");
    ///<summary>65C755 TV Automation</summary>
...
public partial class TimerEntities
{
    ...
    ///<summary>Air Fryer</summary>
    public TimerEntity AirFryer => new(_haContext, "timer.air_fryer");
}
...
public partial class UpdateEntities
{
    ...
    ///<summary>Baby Camera Update</summary>
    public UpdateEntity BabyCameraUpdate => new(_haContext, "update.baby_camera_update");
    ///<summary>Bathroom Motion Sensor Firmware</summary>
    public UpdateEntity BathroomMotionSensorFirmware => new(_haContext, "update.bathroom_motion_sensor_firmware");
    ...
    ///<summary>BudgetBakers Wallet Update</summary>
    public UpdateEntity BudgetbakersWalletUpdate => new(_haContext, "update.budgetbakers_wallet_update");
    ...
    ///<summary>Cloudflared Update</summary>
    public UpdateEntity CloudflaredUpdate => new(_haContext, "update.cloudflared_update");
    ///<summary>Codex Conversation Update</summary>
    public UpdateEntity CodexConversationUpdate => new(_haContext, "update.codex_conversation_update");
    ///<summary>Codex Conversation Update</summary>
    public UpdateEntity CodexConversationUpdate2 => new(_haContext, "update.codex_conversation_update_2");
    ///<summary>Data Annotation Update</summary>
    public UpdateEntity DataannotationProjectsUpdate => new(_haContext, "update.dataannotation_projects_update");
    ///<summary>Desk Motion Sensor Firmware</summary>
    public UpdateEntity DeskMotionSensorFirmware => new(_haContext, "update.desk_motion_sensor_firmware");
    ///<summary>ESPHome Device Builder Update</summary>
    public UpdateEntity EsphomeUpdate => new(_haContext, "update.esphome_update");
    ///<summary>Frosted Glass Theme Update</summary>
    public UpdateEntity FrostedGlassThemeUpdate => new(_haContext, "update.frosted_glass_theme_update");
    ///<summary>Kitchen Motion Sensor Firmware</summary>
    public UpdateEntity GarbageLidFirmware => new(_haContext, "update.garbage_lid_firmware");
    ///<summary>Gitea Update</summary>
    public UpdateEntity GiteaUpdate => new(_haContext, "update.gitea_update");
    ...
    ///<summary>Home Assistant MCP Server Update</summary>
    public UpdateEntity HomeAssistantMcpServerUpdate => new(_haContext, "update.home_assistant_mcp_server_update");
    ...
    ///<summary>Home Assistant Time Machine Update</summary>
    public UpdateEntity HomeAssistantTimeMachineUpdate => new(_haContext, "update.home_assistant_time_machine_update");
    ...
    ///<summary>Linked Cards Update</summary>
    public UpdateEntity LinkedCardsUpdate => new(_haContext, "update.linked_cards_update");
    ...
    ///<summary>MERALCO PH Update</summary>
    public UpdateEntity MeralcoPhUpdate => new(_haContext, "update.meralco_ph_update");
    ...
    ///<summary>Navbar card Update</summary>
    public UpdateEntity NavbarCardUpdate => new(_haContext, "update.navbar_card_update");
    ...
    ///<summary>OpenRouter Fixed Update</summary>
    public UpdateEntity OpenrouterFixedUpdate => new(_haContext, "update.openrouter_fixed_update");
    ///<summary>Pantry Motion Sensor Firmware</summary>
    public UpdateEntity PantryMotionSensorFirmware => new(_haContext, "update.pantry_motion_sensor_firmware");
    ...
    ///<summary>Sala Motion Sensor Firmware</summary>
    public UpdateEntity SalaMotionSensorFirmware => new(_haContext, "update.sala_motion_sensor_firmware");
    ...
    ///<summary>Xiaomi Miot Update</summary>
    public UpdateEntity XiaomiMiotAutoUpdate => new(_haContext, "update.xiaomi_miot_auto_update");
    ///<summary>Zigbee Contact Sensor (Bedroom)</summary>
    public UpdateEntity ZigbeeContactSensorBedroom => new(_haContext, "update.zigbee_contact_sensor_bedroom");
    ///<summary>Zigbee Hygrometer</summary>
    public UpdateEntity ZigbeeHygrometer => new(_haContext, "update.zigbee_hygrometer");
...
public partial class CameraEntities
{
    ...
    ///<summary>Baby Camera HD Stream</summary>
    public CameraEntity BabyCameraHdStream => new(_haContext, "camera.baby_camera_hd_stream");
    ///<summary>Baby Camera HD Stream (Direct)</summary>
    public CameraEntity BabyCameraHdStreamDirect => new(_haContext, "camera.baby_camera_hd_stream_direct");
    ///<summary>Baby Camera SD Stream</summary>
    public CameraEntity BabyCameraSdStream => new(_haContext, "camera.baby_camera_sd_stream");
    ///<summary>Baby Camera SD Stream (Direct)</summary>
    public CameraEntity BabyCameraSdStreamDirect => new(_haContext, "camera.baby_camera_sd_stream_direct");
    ///<summary>Mipad Esphome Device Recording</summary>
    public CameraEntity MipadEsphomeDeviceRecording => new(_haContext, "camera.mipad_esphome_device_recording");
}
...
public partial class NotifyEntities
{
    ...
    ///<summary>Aenics</summary>
    public NotifyEntity Aenics => new(_haContext, "notify.aenics");
    ///<summary>Guest</summary>
    public NotifyEntity Guest => new(_haContext, "notify.guest");
    ///<summary>KRZL 👸🏻</summary>
    public NotifyEntity Krzl => new(_haContext, "notify.krzl");
    ///<summary>MiPad5</summary>
    public NotifyEntity Mipad5 => new(_haContext, "notify.mipad5");
    ///<summary>OnePlus13</summary>
    public NotifyEntity Oneplus13 => new(_haContext, "notify.oneplus13");
    ///<summary>POCO F4 GT</summary>
    public NotifyEntity PocoF4Gt => new(_haContext, "notify.poco_f4_gt");
}
...
public partial class TextEntities
{
    ...
    ///<summary>Mipad Esphome Remote Browser URL</summary>
    public TextEntity MipadEsphomeRemoteBrowserUrl => new(_haContext, "text.mipad_esphome_remote_browser_url");
    ///<summary>Mipad Esphome Screensaver URL</summary>
    public TextEntity MipadEsphomeScreensaverUrl => new(_haContext, "text.mipad_esphome_screensaver_url");
...
public partial class InputTextEntities
{
    ...
    ///<summary>Baby Camera Summary</summary>
    public InputTextEntity BabyCameraSummary => new(_haContext, "input_text.baby_camera_summary");
    ///<summary>Selected AI Task</summary>
    public InputTextEntity SelectedAiTask => new(_haContext, "input_text.selected_ai_task");
}
...
public partial class SirenEntities
{
    ...
    ///<summary>Baby Camera Siren</summary>
    public SirenEntity BabyCameraSiren => new(_haContext, "siren.baby_camera_siren");
}
...
public partial class CalendarEntities
{
    ...
    ///<summary>Epic Games Store Discount games</summary>
    public CalendarEntity EpicGamesStoreDiscountGames => new(_haContext, "calendar.epic_games_store_discount_games");
    ///<summary>Epic Games Store Free games</summary>
    public CalendarEntity EpicGamesStoreFreeGames => new(_haContext, "calendar.epic_games_store_free_games");
}
...
public partial class InputSelectEntities
{
    ...
    ///<summary>Automation Log Level</summary>
    public InputSelectEntity AutomationLogLevel => new(_haContext, "input_select.automation_log_level");
}
...
public partial class AssistSatelliteEntities
{
    ...
    ///<summary>Mipad Esphome Assist satellite</summary>
    public AssistSatelliteEntity MipadEsphomeAssistSatellite => new(_haContext, "assist_satellite.mipad_esphome_assist_satellite");
}
...
public partial record BinarySensorAttributes
{
    ...
    [JsonPropertyName("friendly_name")]
    public string? FriendlyName_0 { get; init; }

    [JsonPropertyName("friendlyName")]
    public string? FriendlyName_1 { get; init; }
    ...
    [JsonPropertyName("lastAttemptedSyncAt")]
    public string? LastAttemptedSyncAt { get; init; }

    [JsonPropertyName("lastSuccessfulSyncAt")]
    public string? LastSuccessfulSyncAt { get; init; }

    [JsonPropertyName("lastError")]
    public object? LastError { get; init; }

    [JsonPropertyName("lastDataChangeAt")]
    public string? LastDataChangeAt { get; init; }

    [JsonPropertyName("lastDataChangeRevision")]
    public string? LastDataChangeRevision { get; init; }
    ...
    [JsonPropertyName("rateLimitLimit")]
    public double? RateLimitLimit { get; init; }
    ...
    [JsonPropertyName("excludeFromStats")]
    public bool? ExcludeFromStats { get; init; }

    [JsonPropertyName("recordCount")]
    public double? RecordCount { get; init; }

    [JsonPropertyName("lastRecordDate")]
    public string? LastRecordDate { get; init; }
    ...
    [JsonPropertyName("balanceAsOf")]
    public object? BalanceAsOf { get; init; }

    [JsonPropertyName("fetchedAt")]
    public string? FetchedAt { get; init; }

    [JsonPropertyName("in_progress_task")]
    public bool? InProgressTask { get; init; }

    [JsonPropertyName("in_progress_task_count")]
    public double? InProgressTaskCount { get; init; }

    [JsonPropertyName("in_progress_tasks")]
    public IReadOnlyList<object>? InProgressTasks { get; init; }

    [JsonPropertyName("in_progress_task_source")]
    public string? InProgressTaskSource { get; init; }

    [JsonPropertyName("page_url")]
    public string? PageUrl { get; init; }

    [JsonPropertyName("scraped_at")]
    public string? ScrapedAt { get; init; }
}
...
public partial record ButtonAttributes
{
    ...
    [JsonPropertyName("clock_data")]
    public object? ClockData { get; init; }

    [JsonPropertyName("dst_data")]
    public object? DstData { get; init; }
}
...
public partial record EventAttributes
{
    ...
    [JsonPropertyName("Connect Device Ids")]
    public string? ConnectDeviceIds { get; init; }
}
...
public partial record SensorAttributes
{
    ...
    public IReadOnlyList<string>? Types_0 { get; init; }

    [JsonPropertyName("types")]
    public IReadOnlyList<string>? Types_1 { get; init; }
    ...
    public object? FloorName { get; init; }

    [JsonPropertyName("floor_level")]
    public object? FloorLevel { get; init; }
    ...
    [JsonPropertyName("android.contains.customView")]
    public bool? Android_contains_customView { get; init; }
    ...
    [JsonPropertyName("android.compactActions")]
    public IReadOnlyList<double>? Android_compactActions { get; init; }

    [JsonPropertyName("android.mediaRemoteDevice")]
    public string? Android_mediaRemoteDevice { get; init; }

    [JsonPropertyName("android.mediaRemoteIcon")]
    public double? Android_mediaRemoteIcon { get; init; }

    [JsonPropertyName("android.substName")]
    public string? Android_substName { get; init; }
    ...
    [JsonPropertyName("tilting")]
    public double? Tilting { get; init; }
    ...
    public IReadOnlyList<string>? LxcOnList { get; init; }
    ...
    public double? ArchivedCount { get; init; }

    [JsonPropertyName("fetchedAt")]
    public string? FetchedAt { get; init; }

    [JsonPropertyName("latestRecordDate")]
    public string? LatestRecordDate { get; init; }

    [JsonPropertyName("latestUpdatedAt")]
    public string? LatestUpdatedAt { get; init; }
    ...
    [JsonPropertyName("balanceAsOf")]
    public string? BalanceAsOf { get; init; }

    [JsonPropertyName("tasks")]
    public double? Tasks { get; init; }

    [JsonPropertyName("pay")]
    public string? Pay { get; init; }

    [JsonPropertyName("base_pay")]
    public string? BasePay { get; init; }

    [JsonPropertyName("priority_pay")]
    public string? PriorityPay { get; init; }
    ...
    [JsonPropertyName("next_withdrawal_amount")]
    public double? NextWithdrawalAmount { get; init; }

    [JsonPropertyName("next_withdrawal_amount_cents")]
    public double? NextWithdrawalAmountCents { get; init; }

    [JsonPropertyName("next_withdrawal_amount_formatted")]
    public string? NextWithdrawalAmountFormatted { get; init; }

    [JsonPropertyName("next_payout_amount")]
    public string? NextPayoutAmount { get; init; }

    [JsonPropertyName("next_payout_at_human")]
    public string? NextPayoutAtHuman { get; init; }

    [JsonPropertyName("next_payout_confidence")]
    public string? NextPayoutConfidence { get; init; }

    [JsonPropertyName("next_payout_entries")]
    public IReadOnlyList<object>? NextPayoutEntries { get; init; }

    [JsonPropertyName("next_payout_entries_count")]
    public double? NextPayoutEntriesCount { get; init; }

    [JsonPropertyName("next_payout_source")]
    public string? NextPayoutSource { get; init; }

    [JsonPropertyName("next_withdrawal_at")]
    public string? NextWithdrawalAt { get; init; }

    [JsonPropertyName("last_payout_amount")]
    public double? LastPayoutAmount { get; init; }

    [JsonPropertyName("last_payout_amount_cents")]
    public double? LastPayoutAmountCents { get; init; }

    [JsonPropertyName("last_payout_amount_formatted")]
    public string? LastPayoutAmountFormatted { get; init; }
}
...
public partial record NumericSensorAttributes
{
    ...
    [JsonPropertyName("excluded_project_count")]
    public double? ExcludedProjectCount { get; init; }

    [JsonPropertyName("excluded_project_names")]
    public IReadOnlyList<string>? ExcludedProjectNames { get; init; }

    [JsonPropertyName("new_task_count")]
    public double? NewTaskCount { get; init; }

    [JsonPropertyName("new_task_detected")]
    public bool? NewTaskDetected { get; init; }

    [JsonPropertyName("new_task_detected_at")]
    public object? NewTaskDetectedAt { get; init; }

    [JsonPropertyName("new_task_project_name")]
    public object? NewTaskProjectName { get; init; }

    [JsonPropertyName("new_task_project_url")]
    public object? NewTaskProjectUrl { get; init; }

    [JsonPropertyName("new_tasks")]
    public IReadOnlyList<object>? NewTasks { get; init; }

    [JsonPropertyName("next_withdrawal_at")]
    public string? NextWithdrawalAt { get; init; }

    [JsonPropertyName("pending_payout_entries")]
    public IReadOnlyList<object>? PendingPayoutEntries { get; init; }
...
public partial record SwitchAttributes
{
    ...
    [JsonPropertyName("sync_hours")]
    public double? SyncHours { get; init; }
...
public partial record CameraAttributes
{
    ...
    public string? MotionDetection { get; init; }
    ...
    [JsonPropertyName("device_alias")]
    public string? DeviceAlias { get; init; }

    [JsonPropertyName("mobile_access")]
    public string? MobileAccess { get; init; }
    ...
    [JsonPropertyName("hw_desc")]
    public string? HwDesc { get; init; }
    ...
    [JsonPropertyName("ffs")]
    public bool? Ffs { get; init; }

    [JsonPropertyName("is_cal")]
    public bool? IsCal { get; init; }

    [JsonPropertyName("avatar")]
    public string? Avatar { get; init; }

    [JsonPropertyName("has_set_location_info")]
    public double? HasSetLocationInfo { get; init; }
    ...
    public object? Presets { get; init; }

    [JsonPropertyName("record_plan")]
    public object? RecordPlan { get; init; }
...
public interface IServices
{
    ...
    TapoControlServices TapoControl { get; }
...
public partial class Services : IServices
{
    ...
    public TapoControlServices TapoControl => new(_haContext);
...
public partial class AndroidtvServices
{
    ...
    ///<param name="command"> eg: HOME</param>
    ...
    ///<param name="devicePath"> eg: /storage/emulated/0/Download/example.txt</param>
    ///<param name="localPath"> eg: /config/www/example.txt</param>
...
{
    ///<summary> eg: /storage/emulated/0/Download/example.txt</summary>
    [JsonPropertyName("device_path")]
    public string? DevicePath { get; init; }

    ///<summary> eg: /config/www/example.txt</summary>
...
public partial class BermudaServices
{
    ...
    ///<param name="addresses"> eg: EE:E8:37:9F:6B:54 C7:B8:C6:B0:27:11 AA:AA:AA:AA:AA:AA</param>
    ///<param name="configuredDevices"> eg: False</param>
    ///<param name="redact"> eg: False</param>
...
{
    ///<summary> eg: EE:E8:37:9F:6B:54 C7:B8:C6:B0:27:11 AA:AA:AA:AA:AA:AA</summary>
...
public partial class BrowserModServices
{
    ...
    ///<summary>Deregister a browser. Include at least one parameter. Calling with either exclude parameter will deregister all browsers except those excluded.</summary>
    ...
    ///<param name="adaptive">Use adaptive dialog instead of standard dialog.</param>
    ///<param name="adaptiveAllowModeChange">Allow adaptive dialog to continually change between standard and adaptive mode based on screen size instead of only on open. This can be used to make the popup responsive to screen size changes while open but may cause issues with content or styles.</param>
    ///<param name="adaptiveForceBottomSheet">Force the popup to always open as a bottom sheet when in adaptive mode.</param>
    ...
    ///<param name="browserId"></param>
    ///<param name="userId"></param>
    ///<param name="localStorageItems">List of local storage items to clear before refresh</param>
    public void Refresh(IEnumerable<string>? browserId = null, IEnumerable<string>? userId = null, IEnumerable<object>? localStorageItems = null)
    {
        _haContext.CallService("browser_mod", "refresh", null, new BrowserModRefreshParameters { BrowserId = browserId, UserId = userId, LocalStorageItems = localStorageItems });
    }
...
public partial record BrowserModPopupParameters
{
    ...
    ///<summary>Use adaptive dialog instead of standard dialog.</summary>
    [JsonPropertyName("adaptive")]
    public bool? Adaptive { get; init; }

    ///<summary>Allow adaptive dialog to continually change between standard and adaptive mode based on screen size instead of only on open. This can be used to make the popup responsive to screen size changes while open but may cause issues with content or styles.</summary>
    [JsonPropertyName("adaptive_allow_mode_change")]
    public bool? AdaptiveAllowModeChange { get; init; }

    ///<summary>Force the popup to always open as a bottom sheet when in adaptive mode.</summary>
    [JsonPropertyName("adaptive_force_bottom_sheet")]
    public bool? AdaptiveForceBottomSheet { get; init; }
...
public partial record BrowserModRefreshParameters
{
    ...
    ///<summary>List of local storage items to clear before refresh</summary>
    [JsonPropertyName("local_storage_items")]
    public IEnumerable<object>? LocalStorageItems { get; init; }
}
...
public partial class EsphomeServices
{
    ...
    ///<summary>Performs the action launch_intent of the node MiPad ESPHOME</summary>
    public void MipadesphomeLaunchIntent(EsphomeMipadesphomeLaunchIntentParameters data)
    {
        _haContext.CallService("esphome", "mipad esphome_launch_intent", null, data);
    }

    ///<summary>Performs the action launch_intent of the node MiPad ESPHOME</summary>
    ///<param name="intentUri"> eg: Example text</param>
    public void MipadesphomeLaunchIntent(string intentUri)
    {
        _haContext.CallService("esphome", "mipad esphome_launch_intent", null, new EsphomeMipadesphomeLaunchIntentParameters { IntentUri = intentUri });
    }

    ///<summary>Performs the action webview_command of the node MiPad ESPHOME</summary>
    public void MipadesphomeWebviewCommand(EsphomeMipadesphomeWebviewCommandParameters data)
    {
        _haContext.CallService("esphome", "mipad esphome_webview_command", null, data);
    }

    ///<summary>Performs the action webview_command of the node MiPad ESPHOME</summary>
    ///<param name="command"> eg: Example text</param>
    public void MipadesphomeWebviewCommand(string command)
    {
        _haContext.CallService("esphome", "mipad esphome_webview_command", null, new EsphomeMipadesphomeWebviewCommandParameters { Command = command });
    }
}

public partial record EsphomeMipadesphomeLaunchIntentParameters
{
    ///<summary> eg: Example text</summary>
    [JsonPropertyName("intent_uri")]
    public string? IntentUri { get; init; }
}

public partial record EsphomeMipadesphomeWebviewCommandParameters
{
    ///<summary> eg: Example text</summary>
    [JsonPropertyName("command")]
    public string? Command { get; init; }
...
public partial class FluxLedServices
{
    ...
    ///<param name="colors"> eg: - [255,0,0] - [0,255,0] - [0,0,255] </param>
    ///<param name="speedPct"> eg: 80</param>
    ///<param name="transition"> eg: jump</param>
    ...
    ///<param name="sensitivity"> eg: 80</param>
    ///<param name="brightness"> eg: 80</param>
    ///<param name="lightScreen"></param>
    ///<param name="effect"> eg: 1</param>
    ///<param name="foregroundColor"> eg: [255, 100, 100]</param>
    ///<param name="backgroundColor"> eg: [255, 100, 100]</param>
    ...
    ///<param name="colors"> eg: - [255,0,0] - [0,255,0] - [0,0,255] - [255,255,255] </param>
    ///<param name="speedPct"> eg: 80</param>
    ///<param name="effect"> eg: running_water</param>
...
{
    ///<summary> eg: - [255,0,0] - [0,255,0] - [0,0,255] - [255,255,255] </summary>
    [JsonPropertyName("colors")]
    public object? Colors { get; init; }
    ...
    ///<summary> eg: running_water</summary>
    [JsonPropertyName("effect")]
...
public partial class NoderedServices
{
    ...
    ///<param name="outputPath"> eg: 1,2</param>
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_guest integration.</summary>
    public void MobileAppGuest(NotifyMobileAppGuestParameters data)
    {
        _haContext.CallService("notify", "mobile_app_guest", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppGuest(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_guest", null, new NotifyMobileAppGuestParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_krzl integration.</summary>
    public void MobileAppKrzl(NotifyMobileAppKrzlParameters data)
    {
        _haContext.CallService("notify", "mobile_app_krzl", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppKrzl(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_krzl", null, new NotifyMobileAppKrzlParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_mipad5 integration.</summary>
    public void MobileAppMipad5(NotifyMobileAppMipad5Parameters data)
    {
        _haContext.CallService("notify", "mobile_app_mipad5", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppMipad5(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_mipad5", null, new NotifyMobileAppMipad5Parameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_oneplus13 integration.</summary>
    public void MobileAppOneplus13(NotifyMobileAppOneplus13Parameters data)
    {
        _haContext.CallService("notify", "mobile_app_oneplus13", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppOneplus13(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_oneplus13", null, new NotifyMobileAppOneplus13Parameters { Message = message, Title = title, Target = target, Data = data });
    }
...
public partial record NotifyMobileAppGuestParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppKrzlParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppMipad5Parameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppOneplus13Parameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial class ScriptServices
{
    ...
    public void AskPcShutdown(object? data = null)
    {
        _haContext.CallService("script", "ask_pc_shutdown", null, data);
    }

    public Task<JsonElement?> AskPcShutdownAsync(object? data = null)
    {
        return _haContext.CallServiceWithResponseAsync("script", "ask_pc_shutdown", null, data);
    }
    ...
    public void SetPocoF4GtAlarm(object? data = null)
    {
        _haContext.CallService("script", "set_poco_f4_gt_alarm", null, data);
    }

    public Task<JsonElement?> SetPocoF4GtAlarmAsync(object? data = null)
    {
        return _haContext.CallServiceWithResponseAsync("script", "set_poco_f4_gt_alarm", null, data);
    }
...
public partial class SshServices
{
    ...
    public void ExecuteCommand(ServiceTarget target, string command, long? timeout = null, object? variables = null)
    {
    ...
    ///<param name="timeout">The timeout of the command.</param>
    ///<param name="variables">Variables to pass to the command. Example: A variable `name` can be used inside the command as `@{name}`.</param>
    public Task<JsonElement?> ExecuteCommandAsync(ServiceTarget target, string command, long? timeout = null, object? variables = null)
    {
...
public partial class TapoControlServices
{
    private readonly IHaContext _haContext;
    public TapoControlServices(IHaContext haContext)
    {
        _haContext = haContext;
    }
    ...
    ///<param name="target">The target for this service call</param>
    public void DeletePreset(ServiceTarget target, TapoControlDeletePresetParameters data)
    {
        _haContext.CallService("tapo_control", "delete_preset", target, data);
    }

    ///<summary>Deletes a preset</summary>
    ///<param name="preset">PTZ preset ID or a Name. See possible presets in entity attributes eg: 1</param>
    public void DeletePreset(ServiceTarget target, string preset)
    {
        _haContext.CallService("tapo_control", "delete_preset", target, new TapoControlDeletePresetParameters { Preset = preset });
    }

    ///<summary>Saves the current PTZ position to a preset</summary>
    ///<param name="target">The target for this service call</param>
    public void SavePreset(ServiceTarget target, TapoControlSavePresetParameters data)
    {
        _haContext.CallService("tapo_control", "save_preset", target, data);
    }

    ///<summary>Saves the current PTZ position to a preset</summary>
    ///<param name="name">Name of the preset. eg: Entry Door</param>
    public void SavePreset(ServiceTarget target, string name)
    {
        _haContext.CallService("tapo_control", "save_preset", target, new TapoControlSavePresetParameters { Name = name });
    }
}

public partial record TapoControlDeletePresetParameters
{
    ///<summary>PTZ preset ID or a Name. See possible presets in entity attributes eg: 1</summary>
    [JsonPropertyName("preset")]
    public string? Preset { get; init; }
}

public partial record TapoControlSavePresetParameters
{
    ///<summary>Name of the preset. eg: Entry Door</summary>
    [JsonPropertyName("name")]
    public string? Name { get; init; }
}
...
public partial class TplinkServices
{
    ...
    ///<param name="initStates"> eg: [199,99,96]</param>
    ///<param name="backgrounds"> eg: - [199, 89, 50] - [160, 50, 50] - [180, 100, 50] </param>
    ///<param name="segments"> eg: 0, 2, 4, 6, 8</param>
    ///<param name="brightness"> eg: 90</param>
    ///<param name="duration"> eg: 0</param>
    ///<param name="transition"> eg: 2000</param>
    ///<param name="fadeoff"> eg: 2000</param>
    ///<param name="hueRange"> eg: 340, 360</param>
    ///<param name="saturationRange"> eg: 40, 95</param>
    ///<param name="brightnessRange"> eg: 90, 100</param>
    ///<param name="transitionRange"> eg: 2000, 6000</param>
    ///<param name="randomSeed"> eg: 80</param>
    ...
    ///<param name="sequence"> eg: - [340, 20, 50] - [20, 50, 50] - [0, 100, 50] </param>
    ///<param name="segments"> eg: 0, 2, 4, 6, 8</param>
    ///<param name="brightness"> eg: 80</param>
    ///<param name="duration"> eg: 0</param>
    ///<param name="repeatTimes"> eg: 0</param>
    ///<param name="transition"> eg: 2000</param>
    ///<param name="spread"> eg: 1</param>
    ///<param name="direction"> eg: 1</param>
...
{
    ///<summary> eg: - [340, 20, 50] - [20, 50, 50] - [0, 100, 50] </summary>
    [JsonPropertyName("sequence")]
    public object? Sequence { get; init; }
...
public partial class TuyaServices
{
    private readonly IHaContext _haContext;
    public TuyaServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    public void GetFeederMealPlan(TuyaGetFeederMealPlanParameters data)
    {
        _haContext.CallService("tuya", "get_feeder_meal_plan", null, data);
    }

    ///<param name="deviceId"></param>
    public void GetFeederMealPlan(string deviceId)
    {
        _haContext.CallService("tuya", "get_feeder_meal_plan", null, new TuyaGetFeederMealPlanParameters { DeviceId = deviceId });
    }

    public Task<JsonElement?> GetFeederMealPlanAsync(TuyaGetFeederMealPlanParameters data)
    {
        return _haContext.CallServiceWithResponseAsync("tuya", "get_feeder_meal_plan", null, data);
    }

    ///<param name="deviceId"></param>
    public Task<JsonElement?> GetFeederMealPlanAsync(string deviceId)
    {
        return _haContext.CallServiceWithResponseAsync("tuya", "get_feeder_meal_plan", null, new TuyaGetFeederMealPlanParameters { DeviceId = deviceId });
    }

    public void SetFeederMealPlan(TuyaSetFeederMealPlanParameters data)
    {
        _haContext.CallService("tuya", "set_feeder_meal_plan", null, data);
    }

    ///<param name="deviceId"></param>
    ///<param name="mealPlan"></param>
    public void SetFeederMealPlan(string deviceId, IEnumerable<object> mealPlan)
    {
        _haContext.CallService("tuya", "set_feeder_meal_plan", null, new TuyaSetFeederMealPlanParameters { DeviceId = deviceId, MealPlan = mealPlan });
    }
}

public partial record TuyaGetFeederMealPlanParameters
{
    [JsonPropertyName("device_id")]
    public string? DeviceId { get; init; }
}

public partial record TuyaSetFeederMealPlanParameters
{
    [JsonPropertyName("device_id")]
    public string? DeviceId { get; init; }

    [JsonPropertyName("meal_plan")]
    public IEnumerable<object>? MealPlan { get; init; }
}
...
public partial class WebrtcServices
{
    ...
    ///<param name="linkId"> eg: fd0a53ca-e9ab-4e7a-86a2-441642b16ae1</param>
    ///<param name="url"> eg: rtsp://rtsp:12345678@192.168.1.123:554/av_stream/ch0</param>
    ///<param name="entity"> eg: camera.generic_stream</param>
    ...
    ///<param name="entityId"> eg: media_player.mibox4</param>
    ///<param name="url"> eg: rtsp://rtsp:12345678@192.168.1.123:554/av_stream/ch0</param>
    ///<param name="entity"> eg: camera.generic_stream</param>
    ///<param name="extra"></param>
    ///<param name="force"></param>
    ///<param name="hassUrl"> eg: http://192.168.1.123:8123</param>
    ...
    public void Reload(object? data = null)
    {
        _haContext.CallService("webrtc", "reload", null, data);
    }
}

public partial record WebrtcCreateLinkParameters
{
    ///<summary> eg: fd0a53ca-e9ab-4e7a-86a2-441642b16ae1</summary>
    [JsonPropertyName("link_id")]
    public string? LinkId { get; init; }

    ///<summary> eg: rtsp://rtsp:12345678@192.168.1.123:554/av_stream/ch0</summary>
    [JsonPropertyName("url")]
    public string? Url { get; init; }

    ///<summary> eg: camera.generic_stream</summary>
    [JsonPropertyName("entity")]
    public string? Entity { get; init; }
...
{
    ///<summary> eg: media_player.mibox4</summary>
    [JsonPropertyName("entity_id")]
    public string? EntityId { get; init; }
    ...
    ///<summary> eg: http://192.168.1.123:8123</summary>
...
public static class FanEntityExtensionMethods
{
    ...
    ///<param name="additionalFields"></param>
    public static void DecreaseSpeed(this FanEntity target, object? additionalFields = null)
    {
        target.CallService("decrease_speed", new FanDecreaseSpeedParameters { AdditionalFields = additionalFields });
    }

    ///<param name="target">The IEnumerable&lt;FanEntity&gt; to call this service for</param>
    ///<param name="additionalFields"></param>
    public static void DecreaseSpeed(this IEnumerable<FanEntity> target, object? additionalFields = null)
    {
        target.CallService("decrease_speed", new FanDecreaseSpeedParameters { AdditionalFields = additionalFields });
    }
    ...
    ///<param name="target">The FanEntity to call this service for</param>
    ///<param name="additionalFields"></param>
    public static void IncreaseSpeed(this FanEntity target, object? additionalFields = null)
    {
        target.CallService("increase_speed", new FanIncreaseSpeedParameters { AdditionalFields = additionalFields });
    }

    ///<param name="target">The IEnumerable&lt;FanEntity&gt; to call this service for</param>
    ///<param name="additionalFields"></param>
    public static void IncreaseSpeed(this IEnumerable<FanEntity> target, object? additionalFields = null)
    {
        target.CallService("increase_speed", new FanIncreaseSpeedParameters { AdditionalFields = additionalFields });
    }
...
{
    public static void ClearLockCredential(this ILockEntityCore target, MatterClearLockCredentialParameters data)
    {
        target.CallService("clear_lock_credential", data);
    }

    public static void ClearLockCredential(this IEnumerable<ILockEntityCore> target, MatterClearLockCredentialParameters data)
    {
        target.CallService("clear_lock_credential", data);
    }
    ...
    ///<param name="credentialType"></param>
    ///<param name="credentialIndex"></param>
    public static void ClearLockCredential(this ILockEntityCore target, object credentialType, long credentialIndex)
    {
        target.CallService("clear_lock_credential", new MatterClearLockCredentialParameters { CredentialType = credentialType, CredentialIndex = credentialIndex });
    }

    ///<param name="target">The IEnumerable&lt;ILockEntityCore&gt; to call this service for</param>
    ///<param name="credentialType"></param>
    ///<param name="credentialIndex"></param>
    public static void ClearLockCredential(this IEnumerable<ILockEntityCore> target, object credentialType, long credentialIndex)
    {
        target.CallService("clear_lock_credential", new MatterClearLockCredentialParameters { CredentialType = credentialType, CredentialIndex = credentialIndex });
    }

    public static void ClearLockUser(this ILockEntityCore target, MatterClearLockUserParameters data)
    {
        target.CallService("clear_lock_user", data);
    }

    public static void ClearLockUser(this IEnumerable<ILockEntityCore> target, MatterClearLockUserParameters data)
    {
        target.CallService("clear_lock_user", data);
    }
    ...
    ///<param name="target">The ILockEntityCore to call this service for</param>
    ///<param name="userIndex"></param>
    public static void ClearLockUser(this ILockEntityCore target, long userIndex)
    {
        target.CallService("clear_lock_user", new MatterClearLockUserParameters { UserIndex = userIndex });
    }

    ///<param name="target">The IEnumerable&lt;ILockEntityCore&gt; to call this service for</param>
    ///<param name="userIndex"></param>
    public static void ClearLockUser(this IEnumerable<ILockEntityCore> target, long userIndex)
    {
        target.CallService("clear_lock_user", new MatterClearLockUserParameters { UserIndex = userIndex });
    }

    public static Task<JsonElement?> GetLockCredentialStatusAsync(this ILockEntityCore target, MatterGetLockCredentialStatusParameters data)
    {
        return target.CallServiceWithResponseAsync("get_lock_credential_status", data);
    }

    ///<param name="target">The ILockEntityCore to call this service for</param>
    ///<param name="credentialType"></param>
    ///<param name="credentialIndex"></param>
    public static Task<JsonElement?> GetLockCredentialStatusAsync(this ILockEntityCore target, object credentialType, long credentialIndex)
    {
        return target.CallServiceWithResponseAsync("get_lock_credential_status", new MatterGetLockCredentialStatusParameters { CredentialType = credentialType, CredentialIndex = credentialIndex });
    }

    public static void GetLockCredentialStatus(this ILockEntityCore target, MatterGetLockCredentialStatusParameters data)
    {
        target.CallService("get_lock_credential_status", data);
    }

    public static void GetLockCredentialStatus(this IEnumerable<ILockEntityCore> target, MatterGetLockCredentialStatusParameters data)
    {
        target.CallService("get_lock_credential_status", data);
    }
    ...
    ///<param name="credentialType"></param>
    ///<param name="credentialIndex"></param>
    public static void GetLockCredentialStatus(this ILockEntityCore target, object credentialType, long credentialIndex)
    {
        target.CallService("get_lock_credential_status", new MatterGetLockCredentialStatusParameters { CredentialType = credentialType, CredentialIndex = credentialIndex });
    }

    ///<param name="target">The IEnumerable&lt;ILockEntityCore&gt; to call this service for</param>
    ///<param name="credentialType"></param>
    ///<param name="credentialIndex"></param>
    public static void GetLockCredentialStatus(this IEnumerable<ILockEntityCore> target, object credentialType, long credentialIndex)
    {
        target.CallService("get_lock_credential_status", new MatterGetLockCredentialStatusParameters { CredentialType = credentialType, CredentialIndex = credentialIndex });
    }

    public static Task<JsonElement?> GetLockInfoAsync(this ILockEntityCore target, object? data = null)
    {
        return target.CallServiceWithResponseAsync("get_lock_info", data);
    }

    public static void GetLockInfo(this ILockEntityCore target, object? data = null)
    {
        target.CallService("get_lock_info", data);
    }

    public static void GetLockInfo(this IEnumerable<ILockEntityCore> target, object? data = null)
    {
        target.CallService("get_lock_info", data);
    }

    public static Task<JsonElement?> GetLockUsersAsync(this ILockEntityCore target, object? data = null)
    {
        return target.CallServiceWithResponseAsync("get_lock_users", data);
    }

    public static void GetLockUsers(this ILockEntityCore target, object? data = null)
    {
        target.CallService("get_lock_users", data);
    }

    public static void GetLockUsers(this IEnumerable<ILockEntityCore> target, object? data = null)
    {
        target.CallService("get_lock_users", data);
    }

    public static Task<JsonElement?> SetLockCredentialAsync(this ILockEntityCore target, MatterSetLockCredentialParameters data)
    {
        return target.CallServiceWithResponseAsync("set_lock_credential", data);
    }
    ...
    ///<param name="userStatus"></param>
    ///<param name="userType"></param>
    public static Task<JsonElement?> SetLockCredentialAsync(this ILockEntityCore target, object credentialType, string credentialData, long? credentialIndex = null, long? userIndex = null, object? userStatus = null, object? userType = null)
    {
        return target.CallServiceWithResponseAsync("set_lock_credential", new MatterSetLockCredentialParameters { CredentialType = credentialType, CredentialData = credentialData, CredentialIndex = credentialIndex, UserIndex = userIndex, UserStatus = userStatus, UserType = userType });
    }

    public static void SetLockCredential(this ILockEntityCore target, MatterSetLockCredentialParameters data)
    {
        target.CallService("set_lock_credential", data);
    }

    public static void SetLockCredential(this IEnumerable<ILockEntityCore> target, MatterSetLockCredentialParameters data)
    {
        target.CallService("set_lock_credential", data);
    }
    ...
    ///<param name="userStatus"></param>
    ///<param name="userType"></param>
    public static void SetLockCredential(this ILockEntityCore target, object credentialType, string credentialData, long? credentialIndex = null, long? userIndex = null, object? userStatus = null, object? userType = null)
    {
        target.CallService("set_lock_credential", new MatterSetLockCredentialParameters { CredentialType = credentialType, CredentialData = credentialData, CredentialIndex = credentialIndex, UserIndex = userIndex, UserStatus = userStatus, UserType = userType });
    }
    ...
    ///<param name="userStatus"></param>
    ///<param name="userType"></param>
    public static void SetLockCredential(this IEnumerable<ILockEntityCore> target, object credentialType, string credentialData, long? credentialIndex = null, long? userIndex = null, object? userStatus = null, object? userType = null)
    {
        target.CallService("set_lock_credential", new MatterSetLockCredentialParameters { CredentialType = credentialType, CredentialData = credentialData, CredentialIndex = credentialIndex, UserIndex = userIndex, UserStatus = userStatus, UserType = userType });
    }

    public static void SetLockUser(this ILockEntityCore target, MatterSetLockUserParameters data)
    {
        target.CallService("set_lock_user", data);
    }

    public static void SetLockUser(this IEnumerable<ILockEntityCore> target, MatterSetLockUserParameters data)
    {
        target.CallService("set_lock_user", data);
    }
    ...
    ///<param name="userType"></param>
    ///<param name="credentialRule"></param>
    public static void SetLockUser(this ILockEntityCore target, long? userIndex = null, string? userName = null, object? userType = null, object? credentialRule = null)
    {
        target.CallService("set_lock_user", new MatterSetLockUserParameters { UserIndex = userIndex, UserName = userName, UserType = userType, CredentialRule = credentialRule });
    }
    ...
    ///<param name="userType"></param>
    ///<param name="credentialRule"></param>
    public static void SetLockUser(this IEnumerable<ILockEntityCore> target, long? userIndex = null, string? userName = null, object? userType = null, object? credentialRule = null)
    {
        target.CallService("set_lock_user", new MatterSetLockUserParameters { UserIndex = userIndex, UserName = userName, UserType = userType, CredentialRule = credentialRule });
    }
}
...
public static class TapoControlEntityExtensionMethods
{
    ///<summary>Deletes a preset</summary>
    public static void DeletePreset(this ICameraEntityCore target, TapoControlDeletePresetParameters data)
    {
        target.CallService("delete_preset", data);
    }

    ///<summary>Deletes a preset</summary>
    public static void DeletePreset(this IEnumerable<ICameraEntityCore> target, TapoControlDeletePresetParameters data)
    {
        target.CallService("delete_preset", data);
    }
    ...
    ///<param name="target">The ICameraEntityCore to call this service for</param>
    ///<param name="preset">PTZ preset ID or a Name. See possible presets in entity attributes eg: 1</param>
    public static void DeletePreset(this ICameraEntityCore target, string preset)
    {
        target.CallService("delete_preset", new TapoControlDeletePresetParameters { Preset = preset });
    }

    ///<summary>Deletes a preset</summary>
    ///<param name="target">The IEnumerable&lt;ICameraEntityCore&gt; to call this service for</param>
    ///<param name="preset">PTZ preset ID or a Name. See possible presets in entity attributes eg: 1</param>
    public static void DeletePreset(this IEnumerable<ICameraEntityCore> target, string preset)
    {
        target.CallService("delete_preset", new TapoControlDeletePresetParameters { Preset = preset });
    }

    ///<summary>Saves the current PTZ position to a preset</summary>
    public static void SavePreset(this ICameraEntityCore target, TapoControlSavePresetParameters data)
    {
        target.CallService("save_preset", data);
    }

    ///<summary>Saves the current PTZ position to a preset</summary>
    public static void SavePreset(this IEnumerable<ICameraEntityCore> target, TapoControlSavePresetParameters data)
    {
        target.CallService("save_preset", data);
    }
    ...
    ///<param name="target">The ICameraEntityCore to call this service for</param>
    ///<param name="name">Name of the preset. eg: Entry Door</param>
    public static void SavePreset(this ICameraEntityCore target, string name)
    {
        target.CallService("save_preset", new TapoControlSavePresetParameters { Name = name });
    }

    ///<summary>Saves the current PTZ position to a preset</summary>
    ///<param name="target">The IEnumerable&lt;ICameraEntityCore&gt; to call this service for</param>
    ///<param name="name">Name of the preset. eg: Entry Door</param>
    public static void SavePreset(this IEnumerable<ICameraEntityCore> target, string name)
    {
        target.CallService("save_preset", new TapoControlSavePresetParameters { Name = name });
    }
}
